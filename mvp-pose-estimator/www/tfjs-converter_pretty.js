...
! function(e, t) {
			...
			return Object.defineProperty(e, "Instance", {
				...
				var r = e.node,
					...
					i = r.reduce((function(e, t) {
						return e[t.name] = n.mapNode(t), t.op.startsWith("Placeholder") ? a.push(e[t.name]) : "Const" === t.op ? o.push(e[t.name]) : null != t.input && 0 !== t.input.length || s.push(e[t.name]), e
					}), {}),
					u = [],
					c = [],
					p = {},
					l = {};
				null != t && (p = this.mapSignatureEntries(t.inputs), l = this.mapSignatureEntries(t.outputs));
				var h = Object.keys(i);
				...
				return null != t.inputs && (n.inputParams = t.inputs.reduce((function(e, t) {
					...
					switch (n.type) {
						case "string":
							void 0 === (a = W(e.attr, n.tfName, n.defaultValue)) && n.tfDeprecatedName && (a = W(e.attr, n.tfDeprecatedName, n.defaultValue));
							break;
						case "string[]":
							void 0 === (a = te(e.attr, n.tfName, n.defaultValue)) && n.tfDeprecatedName && (a = te(e.attr, n.tfDeprecatedName, n.defaultValue));
							break;
						case "number":
							void 0 === (a = H(e.attr, n.tfName, n.defaultValue || 0)) && n.tfDeprecatedName && (a = H(e.attr, n.tfDeprecatedName, n.defaultValue));
							break;
						case "number[]":
						...
						case "bool":
							...
							break;
						case "bool[]":
							void 0 === (a = re(e.attr, n.tfName, n.defaultValue)) && n.tfDeprecatedName && (a = re(e.attr, n.tfDeprecatedName, n.defaultValue));
							break;
						case "shape":
							void 0 === (a = $(e.attr, n.tfName, n.defaultValue)) && n.tfDeprecatedName && (a = $(e.attr, n.tfDeprecatedName, n.defaultValue));
							break;
						case "shape[]":
							void 0 === (a = ne(e.attr, n.tfName, n.defaultValue)) && n.tfDeprecatedName && (a = ne(e.attr, n.tfDeprecatedName, n.defaultValue));
							break;
						case "dtype":
	...
	function U(e, n) {
		var r = Array.isArray(e) ? String.fromCharCode.apply(null, e) : function(e) {
			var n = t.env().global;
			if ("undefined" != typeof n.atob) return n.atob(e);
	...
	function ge(e) {
		return Array.isArray(e) ? ge(e[0]) : e instanceof Float32Array ? "float32" : e instanceof Int32Array || e instanceof Uint8Array || e instanceof Uint8ClampedArray ? "int32" : "number" == typeof e ? "float32" : ve(e) ? "string" : function(e) {
	...
	var Ee = "tfjsflags",
		Ie = function() {
			function e(e) {
				this.global = e, this.flags = {}, this.flagRegistry = {}, this.urlFlags = {}, this.getQueryParams = Oe, this.populateURLFlags()
			}
			return e.prototype.setPlatform = function(e, t) {
				null != this.platform && (De().getBool("IS_TEST") || De().getBool("PROD") || console.warn("Platform ".concat(this.platformName, " has already been set. ") + "Overwriting the platform with ".concat(e, "."))), this.platformName = e, this.platform = t
				...
				if (this.flagRegistry[e] = {
					...
					De().getBool("IS_TEST") || De().getBool("PROD") || console.warn("Setting feature override from URL ".concat(e, ": ").concat(r, ".")), this.set(e, r)
				}
				...
				if (_e(t)) throw new Error("Flag ".concat(e, " cannot be synchronously evaluated. ") + "Please use getAsync() instead.");
	...
	function ot(e, t) {
		var n, r, a;
		return t ? (a = 0 <= (e >>>= 0) && e < 256) && (r = at[e]) ? r : (n = it(e, (0 | e) < 0 ? -1 : 0, !0), a && (at[e] = n), n) : (a = -128 <= (e |= 0) && e < 128) && (r = rt[e]) ? r : (n = it(e, e < 0 ? -1 : 0, !1), a && (rt[e] = n), n)
	}
	...
	function pt(e, t) {
		return "number" == typeof e ? st(e, t) : "string" == typeof e ? ct(e, t) : it(e.low, e.high, "boolean" == typeof t ? t : e.unsigned)
	}
	...
	kt.toInt = function() {
		...
		return nt(e) || (e = pt(e)), (this.unsigned === e.unsigned || this.high >>> 31 != 1 || e.high >>> 31 != 1) && (this.high === e.high && this.low === e.low)
		...
		var t = this.high >>> 16,
			...
			p = 0,
			l = 0;
		return p += (l += a + (65535 & e.low)) >>> 16, c += (p += r + i) >>> 16, u += (c += n + s) >>> 16, u += t + o, it((p &= 65535) << 16 | (l &= 65535), (u &= 65535) << 16 | (c &= 65535), this.unsigned)
	}, kt.subtract = function(e) {
		return nt(e) || (e = pt(e)), this.add(e.neg())
	}, kt.sub = kt.subtract, kt.multiply = function(e) {
		if (this.isZero()) return mt;
		if (nt(e) || (e = pt(e)), et) return it(et.mul(this.low, this.high, e.low, e.high), et.get_high(), this.unsigned);
		...
		var t = this.high >>> 16,
			...
			l = 0,
			d = 0;
		return l += (d += a * u) >>> 16, p += (l += r * u) >>> 16, l &= 65535, p += (l += a * i) >>> 16, c += (p += n * u) >>> 16, p &= 65535, c += (p += r * i) >>> 16, p &= 65535, c += (p += a * s) >>> 16, c += t * u + n * i + r * s + a * o, it((l &= 65535) << 16 | (d &= 65535), (c &= 65535) << 16 | (p &= 65535), this.unsigned)
	}, kt.mul = kt.multiply, kt.divide = function(e) {
		if (nt(e) || (e = pt(e)), e.isZero()) throw Error("division by zero");
		var t, n, r;
		if (et) return this.unsigned || -2147483648 !== this.high || -1 !== e.low || -1 !== e.high ? it((this.unsigned ? et.div_u : et.div_s)(this.low, this.high, e.low, e.high), et.get_high(), this.unsigned) : this;
		...
		if (this.unsigned) {
			...
			if (this.eq(wt)) return e.eq(vt) || e.eq(bt) ? wt : e.eq(wt) ? vt : (t = this.shr(1).div(e).shl(1)).eq(mt) ? e.isNegative() ? vt : bt : (n = this.sub(e.mul(t)), r = t.add(n.div(e)));
		...
		for (n = this; n.gte(e);) {
			...
			for (var a = Math.ceil(Math.log(t) / Math.LN2), o = a <= 48 ? 1 : ut(2, a - 48), s = st(t), i = s.mul(e); i.isNegative() || i.gt(n);) i = (s = st(t -= o, this.unsigned)).mul(e);
			s.isZero() && (s = vt), r = r.add(s), n = n.sub(i)
		}
		return r
	}, kt.div = kt.divide, kt.modulo = function(e) {
		return nt(e) || (e = pt(e)), et ? it((this.unsigned ? et.rem_u : et.rem_s)(this.low, this.high, e.low, e.high), et.get_high(), this.unsigned) : this.sub(this.div(e).mul(e))
		...
		return nt(e) && (e = e.toInt()), 0 == (e &= 63) ? this : e < 32 ? it(this.low << e, this.high << e | this.low >>> 32 - e, this.unsigned) : it(0, this.low << e - 32, this.unsigned)
	}, kt.shl = kt.shiftLeft, kt.shiftRight = function(e) {
		return nt(e) && (e = e.toInt()), 0 == (e &= 63) ? this : e < 32 ? it(this.low >>> e | this.high << 32 - e, this.high >> e, this.unsigned) : it(this.high >> e - 32, this.high >= 0 ? 0 : -1, this.unsigned)
	}, kt.shr = kt.shiftRight, kt.shiftRightUnsigned = function(e) {
		if (nt(e) && (e = e.toInt()), 0 === (e &= 63)) return this;
		var t = this.high;
		return e < 32 ? it(this.low >>> e | t << 32 - e, t >>> e, this.unsigned) : it(32 === e ? t : t >>> e - 32, 0, this.unsigned)
		...
		return new tt(e[0] | e[1] << 8 | e[2] << 16 | e[3] << 24, e[4] | e[5] << 8 | e[6] << 16 | e[7] << 24, t)
	}, tt.fromBytesBE = function(e, t) {
		return new tt(e[4] << 24 | e[5] << 16 | e[6] << 8 | e[7], e[0] << 24 | e[1] << 16 | e[2] << 8 | e[3], t)
	};
	var Tt = Ye($e),
		St = Tt || r({
			__proto__: null,
	...
	function Dt(e, t, n) {
		var r, a;
		if (void 0 === t && (t = []), void 0 === n && (n = !1), null == t && (t = []), "boolean" == typeof e || "number" == typeof e || "string" == typeof e || _e(e) || null == e || At(e) && n) t.push(e);
	...
	var Ct = function() {
		...
		return e.prototype.logKernelProfile = function(e, t, n, r, a, o) {
			...
			console.log("%c".concat(i, "\t%c").concat(s, "\t%c").concat(u, "D ").concat(p, "\t%c").concat(c, "\t%c").concat(l, "\t%c").concat(o), "font-weight:bold", "color:red", "color:blue", "color: orange", "color: green", "color: steelblue")
		}, e
	}();
	...
	function Ft(e, t, n, r) {
		var a = xe(t),
			...
			i = Lt(e, t, n, a, o),
			u = ["Tensor"];
		return r && (u.push("  dtype: ".concat(n)), u.push("  rank: ".concat(s)), u.push("  shape: [".concat(t, "]")), u.push("  values:")), u.push(i.map((function(e) {
			return "    " + e
		})).join("\n")), u.join("\n")
	}

	function Rt(e, t, n) {
		return he(Array.isArray(e) ? "".concat(parseFloat(e[0].toFixed(7)), " + ") + "".concat(parseFloat(e[1].toFixed(7)), "j") : ve(e) ? "'".concat(e, "'") : "bool" === n ? zt(e) : parseFloat(e.toFixed(7)).toString(), t)
	}
	...
	function Lt(e, t, n, r, a, o) {
		...
		var s = "complex64" === n ? 2 : 1,
			i = t[0],
			u = t.length;
		if (0 === u) return "complex64" === n ? [Rt(Vt(e)[0], 0, n)] : "bool" === n ? [zt(e[0])] : [e[0].toString()];
		if (1 === u) {
			if (i > 20) {
				var c = 3 * s,
				...
				try {
					for (var o = l(n), s = o.next(); !s.done; s = o.next()) {
						...
						if (i < 0 || i >= this.shape[a]) {
							var u = "Requested out of range element at ".concat(n, ". ") + "  Buffer shape=".concat(this.shape);
							throw new Error(u)
						}
						a++
					}
	...
	var jt = function() {
		function e(e, t, n, r) {
			this.kept = !1, this.isDisposedInternal = !1, this.shape = e.slice(), this.dtype = t || "float32", this.size = pe(e), this.strides = xe(e), this.dataId = n, this.id = r, this.rankType = this.rank < 5 ? this.rank.toString() : "higher"
		}
		return Object.defineProperty(e.prototype, "rank", {
				...
				return p(this, (function(t) {
					switch (t.label) {
						case 0:
							return [4, this.data()];
						case 1:
							return e = t.sent(), [2, Kt.buffer(this.shape, this.dtype, e)]
					}
				}))
			}))
				...
				return p(this, (function(t) {
					switch (t.label) {
						case 0:
							return [4, this.data()];
						case 1:
							return e = t.sent(), [2, we(this.shape, e, "complex64" === this.dtype)]
					}
				}))
			}))
			...
			return c(this, void 0, void 0, (function() {
				...
				return p(this, (function(n) {
					switch (n.label) {
						case 0:
							return this.throwIfDisposed(), e = Bt().read(this.dataId), "string" !== this.dtype ? [3, 2] : [4, e];
						case 1:
							t = n.sent();
							try {
			...
			return c(this, void 0, void 0, (function() {
				...
				return p(this, (function(t) {
					switch (t.label) {
						case 0:
							return this.throwIfDisposed(), [4, Bt().read(this.dataId)];
						case 1:
			...
			this.isDisposed || (this.kerasMask && this.kerasMask.dispose(), Bt().disposeTensor(this), this.isDisposedInternal = !0)
	...
	var Ut, Wt, Gt, Ht, Zt, Qt = function(e) {
		...
		return u(t, e), t.prototype.assign = function(e) {
			...
			if (!le(e.shape, this.shape)) throw new Error("shape of the new value (".concat(e.shape, ") and ") + "previous value (".concat(this.shape, ") must match"));
	...
	var rn = function() {
		...
		an = function() {
			function e(e) {
				this.ENV = e, this.registry = {}, this.registryFactory = {}, this.pendingBackendInitId = 0, this.state = new rn
			}
			return e.prototype.ready = function() {
				...
				return void 0 === n && (n = 1), e in this.registryFactory ? (Ue("".concat(e, " backend was already registered. ") + "Reusing existing backend factory."), !1) : (this.registryFactory[e] = {
					factory: t,
					priority: n
				}, !0)
					...
					return p(this, (function(a) {
						switch (a.label) {
							...
							case 3:
								...
								a.label = 4;
							case 4:
								return this.backendInstance = this.registry[e], this.setupRegisteredKernels(), this.profiler = new Mt(this.backendInstance), [2, !0]
						}
					}))
				}))
				...
				try {
					...
					var a = ++this.pendingBackendInitId,
						o = r.then((function(n) {
							...
							return a < t.pendingBackendInitId || (t.pendingBackendInit = null, Ue("Initialization of backend ".concat(e, " failed")), Ue(n.stack || n.message)), !1
						}));
					...
					return Ue("Initialization of backend ".concat(e, " failed")), Ue(t.stack || t.message), {
						success: !1,
						asyncInit: !1
					}
				}
				...
				var n = this.state.tensorInfo.get(t),
					...
					a = this.readSync(t),
					o = r.refCount(t);
				r.disposeData(t, !0), n.backend = e, e.move(t, a, n.shape, n.dtype, o), this.shouldCheckForMemLeaks() && this.state.numDataMovesStack[this.state.numDataMovesStack.length - 1]++
				...
				if (null == this.backendName && this.backend, !(null != He(e, this.backendName))) throw new Error("Kernel '".concat(e, "' not registered for backend '").concat(this.backendName, "'"));
				...
				var c = nn(e) ? e.kernelName : null != this.state.activeScope ? this.state.activeScope.name : "";
				if (nn(e)) {
					var p = e.kernelName,
						l = e.inputs,
						d = e.attrs;
					...
					ie(null != h, (function() {
						return "Cannot find registered kernel '".concat(p, "' for backend '").concat(a.backendName, "'")
					})), n = function() {
				...
				return this.scopedRun((function() {
					...
					a.ENV.getBool("DEBUG") || a.state.profiling ? (y = a.profiler.profileKernel(c, v, (function() {
						return n()
					})), a.ENV.getBool("DEBUG") && a.profiler.logKernelProfile(y), t = y.outputs) : t = n()
				})), s && this.addTapeNode(c, v, t, b, o, g), this.state.profiling && this.state.activeProfile.kernels.push({
					name: c,
				...
				"string" === n && ve(e[0]) && (a = e.map((function(e) {
					return t = e, void 0 === n && (n = "utf-8"), n = n || "utf-8", De().platform.encode(t, n);
					var t, n
				})));
				var o = r.write(a, t, n),
				...
				var n = 0;
				"complex64" !== e.dtype && "string" !== e.dtype && (n = e.size * ye(e.dtype)), this.state.numBytes += n, this.state.tensorInfo.has(e.dataId) || (this.state.numDataBuffers++, this.state.tensorInfo.set(e.dataId, {
				...
				return c(this, void 0, void 0, (function() {
					...
					return p(this, (function(p) {
						switch (p.label) {
							case 0:
								return this.state.profiling = !0, t = this.state.numBytes, n = this.state.numTensors, this.state.activeProfile.kernels = [], r = this.state.activeProfile, [4, e()];
							case 1:
								r.result = p.sent(), this.state.profiling = !1, this.state.activeProfile.peakBytes = Math.max.apply(Math, h([], d(this.state.activeProfile.kernels.map((function(e) {
									return e.totalBytesSnapshot
								}))), !1)), this.state.activeProfile.newBytes = this.state.numBytes - t, this.state.activeProfile.newTensors = this.state.numTensors - n, p.label = 2;
							case 2:
								p.trys.push([2, 8, 9, 10]), a = l(this.state.activeProfile.kernels), o = a.next(), p.label = 3;
							case 3:
								return o.done ? [3, 7] : (s = o.value, i = s, [4, s.kernelTimeMs]);
							case 4:
								return i.kernelTimeMs = p.sent(), u = s, [4, s.extraInfo];
							case 5:
				...
				return this.tidy("backward", (function() {
					var e, r, i = {};
					i[o.id] = null == n ? (e = o.shape, r = ke(pe(e), "float32"), on.makeTensor(r, e, "float32")) : n,
						function(e, t, n, r) {
							for (var a = function(a) {
									...
									if (o.outputs.forEach((function(t) {
										...
										})), null == o.gradient) throw new Error("Cannot compute gradient: gradient function not found " + "for ".concat(o.kernelName, "."));
									var i = o.gradient(s),
										u = function(t) {
											if (!(t in i)) throw new Error("Cannot backprop through input ".concat(t, ". ") + "Available gradients found: ".concat(Object.keys(i), "."));
											var a = n((function() {
												return i[t]()
											}));
											if ("float32" !== a.dtype) throw new Error("Error in gradient for op ".concat(o.kernelName, ". The gradient of input ") + "".concat(t, " must have 'float32' dtype, but has '").concat(a.dtype, "'"));
											var s = o.inputs[t];
											if (!le(a.shape, s.shape)) throw new Error("Error in gradient for op ".concat(o.kernelName, ". The gradient of input ") + "'".concat(t, "' has shape '").concat(a.shape, "', which does not match ") + "the shape of the input '".concat(s.shape, "'"));
					...
					return 0 === a.state.gradientDepth && (a.state.activeTape.forEach((function(e) {
						var t, n;
						try {
							for (var r = l(e.saved), a = r.next(); !a.done; a = r.next()) {
								a.value.dispose()
							}
						} catch (e) {
							t = {
				...
				return ie(be(e), (function() {
					...
					function() {
						...
						var s = function(t, a) {
								return ie((n = e.apply(void 0, h([], d(h(h([], d(r), !1), [a], !1)), !1))).value instanceof jt, (function() {
				...
				for (var e in this.pendingBackendInitId++, this.state.dispose(), this.ENV.reset(), this.state = new rn, this.registry) this.disposeRegisteredKernels(e), this.registry[e].dispose(), delete this.registry[e];
	...
	function ln(e, t, n, r) {
		...
		var a = ge(e);
		if ("string" !== a && ["bool", "int32", "float32"].indexOf(r) >= 0 && (a = r), pn(r, a, t, n), null == e || !At(e) && !Array.isArray(e) && "number" != typeof e && "boolean" != typeof e && "string" != typeof e) {
	...
	function dn(e, t, n, r) {
		if (void 0 === r && (r = "numeric"), !Array.isArray(e)) throw new Error("Argument ".concat(t, " passed to ").concat(n, " must be a ") + "`Tensor[]` or `TensorLike[]`");
	...
	var bn = fn({
		addN_: function(e) {
			...
			t.forEach((function(e) {
				...
				if (!le(e.shape, n.shape)) throw new Error("All tensors passed to tf.addN() must have the same shape")
			}));
			var r = t;
	...
	var Pn = fn({
		avgPool_: function(e, t, n, r, a) {
			...
			var s = o,
				i = !1;
			3 === o.rank && (i = !0, s = Vn(o, [1, o.shape[0], o.shape[1], o.shape[2]])), ie(4 === s.rank, (function() {
	...
	var Bn = fn({
		avgPool3d_: function(e, t, n, r, a, o) {
			...
			var s = ln(e, "x", "avgPool3d", "float32"),
				i = s,
				u = !1;
			4 === s.rank && (u = !0, i = Vn(s, [1, s.shape[0], s.shape[1], s.shape[2], s.shape[3]])), ie(5 === i.rank, (function() {
			...
			})), ie("number" == typeof n && n > 0 || Array.isArray(n) && n[0] > 0 && n[1] > 0 && n[2] > 0, (function() {
			...
			return l = On(l, i.dtype), u ? Vn(l, [l.shape[1], l.shape[2], l.shape[3], l.shape[4]]) : l
		}
	});
	var Kn = fn({
		clone_: function(e) {
	...
	var Xn = fn({
		batchNorm_: function(e, t, n, r, a, o) {
			...
			null != a && (s = ln(a, "scale", "batchNorm")), null != r && (i = ln(r, "offset", "batchNorm")), ie(c.rank === p.rank, (function() {
			...
			var l = function(e) {
					return 0 === e.rank || 1 === e.rank ? Vn(e, [1, 1, 1, e.size]) : 2 === e.rank ? Vn(e, [1, 1, e.shape[0], e.shape[1]]) : 3 === e.rank ? Vn(e, [1, e.shape[0], e.shape[1], e.shape[2]]) : e
				}(u),
				d = {
					x: l,
					scale: s,
	...
	var Yn = fn({
		batchNorm2d_: function(e, t, n, r, a, o) {
			var s, i, u = ln(e, "x", "batchNorm"),
				c = ln(t, "mean", "batchNorm"),
				p = ln(n, "variance", "batchNorm");
			return null != a && (s = ln(a, "scale", "batchNorm")), null != r && (i = ln(r, "offset", "batchNorm")), ie(2 === u.rank, (function() {
				...
				return "Error in batchNorm2D: variance must be rank 2 or rank 1 " + "but got rank ".concat(p.rank, ".")
			})), null != s && ie(2 === s.rank || 1 === s.rank, (function() {
				return "Error in batchNorm2D: scale must be rank 2 or rank 1 " + "but got rank ".concat(s.rank, ".")
			})), null != i && ie(2 === i.rank || 1 === i.rank, (function() {
				return "Error in batchNorm2D: offset must be rank 2 or rank 1 " + "but got rank ".concat(i.rank, ".")
			})), Xn(u, c, p, i, s, o)
		}
	});
	var Jn = fn({
		batchNorm3d_: function(e, t, n, r, a, o) {
			var s, i, u = ln(e, "x", "batchNorm"),
				c = ln(t, "mean", "batchNorm"),
				p = ln(n, "variance", "batchNorm");
			return null != a && (s = ln(a, "scale", "batchNorm")), null != r && (i = ln(r, "offset", "batchNorm")), ie(3 === u.rank, (function() {
				...
				return "Error in batchNorm3D: variance must be rank 3 or rank 1 " + "but got rank ".concat(p.rank, ".")
			})), null != s && ie(3 === s.rank || 1 === s.rank, (function() {
				return "Error in batchNorm3D: scale must be rank 3 or rank 1 " + "but got rank ".concat(s.rank, ".")
			})), null != i && ie(3 === i.rank || 1 === i.rank, (function() {
				return "Error in batchNorm3D: offset must be rank 3 or rank 1 " + "but got rank ".concat(i.rank, ".")
			})), Xn(u, c, p, i, s, o)
		}
	});
	var $n = fn({
		batchNorm4d_: function(e, t, n, r, a, o) {
			var s, i, u = ln(e, "x", "batchNorm"),
				c = ln(t, "mean", "batchNorm"),
				p = ln(n, "variance", "batchNorm");
			return null != a && (s = ln(a, "scale", "batchNorm")), null != r && (i = ln(r, "offset", "batchNorm")), ie(4 === u.rank, (function() {
				...
				return "Error in batchNorm4D: variance must be rank 4 or rank 1 " + "but got rank ".concat(p.rank, ".")
			})), null != s && ie(4 === s.rank || 1 === s.rank, (function() {
				return "Error in batchNorm4D: scale must be rank 4 or rank 1 " + "but got rank ".concat(s.rank, ".")
			})), null != i && ie(4 === i.rank || 1 === i.rank, (function() {
				return "Error in batchNorm4D: offset must be rank 4 or rank 1 " + "but got rank ".concat(i.rank, ".")
			})), Xn(u, c, p, i, s, o)
		}
	});
	var er = fn({
	...
	var tr = fn({
		bitwiseAnd_: function(e, t) {
			var n = ln(e, "x", "bitwiseAnd"),
				r = ln(t, "y", "bitwiseAnd");
			if (!le(n.shape, r.shape)) throw new Error("BitwiseAnd: Tensors must have the same shape. x: ".concat(n.shape, ", y: ").concat(r.shape));
	...
	var rr = fn({
		broadcastTo_: function(e, t) {
			var n = ln(e, "broadcastTo", "x"),
				r = n.shape;
			if (Se(t), t.length < n.rank) throw new Error("broadcastTo(): shape.length=".concat(t.length, " < input.rank=").concat(n.rank, "."));
			if (t.length > n.rank) {
			...
			for (var o = n.shape, s = Array.from(t), i = t.length - 1; i >= 0; i--)
				if (o[i] === t[i]) s[i] = 1;
				else if (1 !== n.shape[i]) throw new Error("broadcastTo(): [".concat(r, "] cannot be broadcast to [").concat(t, "]."));
	...
	var ur = fn({
		complex_: function(e, t) {
			var n = ln(e, "real", "complex"),
				r = ln(t, "imag", "complex");
			ue(n.shape, r.shape, "real and imag shapes, ".concat(n.shape, " and ").concat(r.shape, ", ") + "must match in call to tf.complex().");
			var a = {
				real: n,
				imag: r
			};
	...
	var hr = fn({
		conv2d_: function(e, t, n, r, a, o, s) {
			...
			var i = ln(e, "x", "conv2d", "float32"),
				...
				c = i,
				p = !1;
			3 === i.rank && (p = !0, c = Vn(i, [1, i.shape[0], i.shape[1], i.shape[2]])), ie(4 === c.rank, (function() {
			...
			ie(l === u.shape[2], (function() {
				return "Error in conv2d: depth of input (".concat(l, ") must match ") + "input depth for filter ".concat(u.shape[2], ".")
			})), ie(Rn(n, o), (function() {
	...
	var fr = fn({
		conv1d_: function(e, t, n, r, a, o, s) {
			...
			var i = ln(e, "x", "conv1d"),
				...
				c = i,
				p = !1;
			2 === i.rank && (p = !0, c = Vn(i, [1, i.shape[0], i.shape[1]])), ie(3 === c.rank, (function() {
	...
	var mr = fn({
		conv2DBackpropInput_: function(e, t, n, r, a, o, s) {
			...
			var i = e,
				u = t,
				c = !1;
			3 === t.rank && (c = !0, u = Vn(t, [1, t.shape[0], t.shape[1], t.shape[2]]), i = [1, e[0], e[1], e[2]]), ie(4 === i.length, (function() {
			...
			ie(p === n.shape[2], (function() {
				return "Error in conv2dDerInput: depth of input (".concat(p, ") must ") + "match input depth for filter ".concat(n.shape[2], ".")
			})), ie(l === n.shape[3], (function() {
				return "Error in conv2dDerInput: depth of output (".concat(l, ") must ") + "match output depth for filter ".concat(n.shape[3], ".")
	...
	var vr = fn({
		conv3d_: function(e, t, n, r, a, o) {
			...
			var s = ln(e, "x", "conv3d"),
				...
				u = s,
				c = !1;
			4 === s.rank && (c = !0, u = Vn(s, [1, s.shape[0], s.shape[1], s.shape[2], s.shape[3]])), ie(5 === u.rank, (function() {
	...
	var gr = fn({
		conv3DBackpropInput_: function(e, t, n, r, a) {
			...
			var o = e,
				s = t,
				i = !1;
			4 === t.rank && (i = !0, s = Vn(t, [1, t.shape[0], t.shape[1], t.shape[2], t.shape[3]]), o = [1, e[0], e[1], e[2], e[3]]);
			var u = o[4],
				c = s.shape[4];
			ie(5 === o.length, (function() {
				...
				return "Error in conv3dDerInput: dy must be rank 5, but got " + "rank ".concat(s.rank)
	...
	var Tr = fn({
		denseBincount_: function(e, t, n, r) {
			...
			ie("int32" === a.dtype, (function() {
				...
				return "Error in denseBincount: weights must have the same shape as x or " + "0-length, but got x shape: ".concat(a.shape, ", weights shape: ") + "".concat(o.shape, ".")
			}));
			var s = {
					x: a,
					weights: o
	...
	var Sr = fn({
		depthToSpace_: function(e, t, n) {
			...
			ie(t > 1, (function() {
				...
				return "Dimension size must be evenly divisible by ".concat(t * t, " but is ").concat(s, " for depthToSpace with input shape ").concat(r.shape)
			}));
			var i = {
					x: r
				},
	...
	var _r = fn({
		depthwiseConv2d_: function(e, t, n, r, a, o, s) {
			...
			var l = "NHWC" === a ? c.shape[3] : c.shape[1];
			ie(l === u.shape[2], (function() {
				return "Error in depthwiseConv2d: number of input channels " + "(".concat(l, ") must match the inChannels dimension in ") + "filter ".concat(u.shape[2], ".")
	...
	var Ir = fn({
		dilation2d_: function(e, t, n, r, a, o) {
			...
			ie(3 === s.rank || 4 === s.rank, (function() {
				return "Error in dilation2d: input must be rank 3 or 4, but got rank " + "".concat(s.rank, ".")
			...
			var u = s,
				c = !1;
			3 === s.rank && (u = Vn(s, [1, s.shape[0], s.shape[1], s.shape[2]]), c = !0), ie(u.shape[3] === i.shape[2], (function() {
				return "Error in dilation2d:  input and filter must have the same depth: ".concat(u.shape[3], " vs ").concat(i.shape[2])
			}));
			var p = {
					x: u,
					filter: i
	...
	var Ar = fn({
		div_: function(e, t) {
			var n, r = ln(e, "a", "div"),
				a = ln(t, "b", "div");
			if (r = (n = d($t(r, a), 2))[0], a = n[1], "int32" === r.dtype && "int32" === a.dtype) return Or(r, a);
			var o = {
				a: r,
				b: a
			};
	...
	function Dr(e, t) {
		for (var n = Math.max(e.length, t.length), r = new Array(n), a = 0; a < n; a++) {
			...
			if (null == s && (s = 1), 1 === o) r[n - a - 1] = s;
				...
				if (o !== s) {
					var i = "Operands could not be broadcast together with shapes " + "".concat(e, " and ").concat(t, ".");
					throw Error(i)
				}
				r[n - a - 1] = o
			}
	...
	var Pr = fn({
		ensureShape_: function(e, t) {
			...
			if (! function(e, t) {
					...
					return !0
				}(n.shape, t)) throw new Error("EnsureShape: Shape of tensor ".concat(n.shape, " is not compatible with expected shape ").concat(t));
			return e
		}
	});
	var Br = fn({
	...
	function Kr(e, t) {
		return function(e, t, n) {
			for (var r = e.length + t.length, a = [], o = 0, s = 0, i = 0; i < r; i++) - 1 === n.indexOf(i) ? a.push(e[o++]) : a.push(t[s++]);
			return a
		}(e, t.map((function(e) {
			return 1
		})), t)
	...
	function Wr(e, t, n, r) {
		...
		if (!At(e) && !Array.isArray(e) && "number" != typeof e && "boolean" != typeof e && "string" != typeof e) throw new Error("values passed to tensor(values) must be a number/boolean/string or an array of numbers/booleans/strings, or a TypedArray");
		if (null != t) {
			Se(t);
			var a = pe(t),
				o = pe(n);
		...
		return At(e) || Array.isArray(e) || (e = [e]), t = t || n, e = "string" !== r ? Et(e, r) : Dt(e, [], !0), on.makeTensor(e, t, r)
	}

	function Gr(e, t) {
		if ((At(e) && "string" !== t || Array.isArray(e)) && "complex64" !== t) throw new Error("Error creating a new Scalar: value must be a primitive (number|boolean|string)");
		if ("string" === t && At(e) && !(e instanceof Uint8Array)) throw new Error("When making a scalar from encoded string, the value must be `Uint8Array`.");
		return Wr(e, [], [], t)
	}
	var Hr = fn({
		sqrt_: function(e) {
	...
	var Aa = fn({
		searchSorted_: function(e, t, n) {
			...
			if (i.shape[1] >= Oa) throw new Error("trailing dim_size must less than ".concat(Oa, " for int32 output type, was ").concat(i.shape[1]));
			var c = {
					sortedSequence: i,
					values: u
				},
	...
	var Da = fn({
		maxPool_: function(e, t, n, r, a) {
			var o = ln(e, "x", "maxPool"),
				...
				i = !1;
			3 === o.rank && (i = !0, s = Vn(o, [1, o.shape[0], o.shape[1], o.shape[2]])), ie(4 === s.rank, (function() {
				return "Error in maxPool: input must be rank 4 but got rank ".concat(s.rank, ".")
			})), ie(Rn(n, 1), (function() {
	...
	var Fa = fn({
		maximum_: function(e, t) {
			var n, r = ln(e, "a", "maximum"),
				a = ln(t, "b", "maximum");
			r = (n = d($t(r, a), 2))[0], a = n[1], "bool" === r.dtype && (r = On(r, "int32"), a = On(a, "int32")), Dr(r.shape, a.shape);
			var o = {
				a: r,
				b: a
			};
	...
	var Pa = fn({
		mirrorPad_: function(e, t, n) {
			...
			for (var a = "reflect" === n ? 1 : 0, o = function(e) {
					...
					})), ie(t[e][0] >= 0 && t[e][0] <= r.shape[e] - a && t[e][1] >= 0 && t[e][1] <= r.shape[e] - a, (function() {
	...
	var ja = fn({
		multiRNNCell_: function(e, t, n, r) {
			for (var a = ln(t, "data", "multiRNNCell"), o = dn(n, "c", "multiRNNCell"), s = dn(r, "h", "multiRNNCell"), i = a, u = [], c = 0; c < e.length; c++) {
				var p = e[c](i, o[c], s[c]);
	...
	var Wa = fn({
		oneHot_: function(e, t, n, r, a) {
			if (void 0 === n && (n = 1), void 0 === r && (r = 0), void 0 === a && (a = "int32"), t < 2) throw new Error("Error in oneHot: depth must be >=2, but it is ".concat(t));
			var o = {
	...
	var Xa = fn({
		pad2d_: function(e, t, n) {
			return void 0 === n && (n = 0), ie(2 === t.length && 2 === t[0].length && 2 === t[1].length, (function() {
				return "Invalid number of paddings. Must be length of 2 each."
			})), Za(e, t, n)
		}
	});
	var Ya = fn({
		pad3d_: function(e, t, n) {
			return void 0 === n && (n = 0), ie(3 === t.length && 2 === t[0].length && 2 === t[1].length && 2 === t[2].length, (function() {
				return "Invalid number of paddings. Must be length of 2 each."
			})), Za(e, t, n)
		}
	});
	var Ja = fn({
		pad4d_: function(e, t, n) {
			return void 0 === n && (n = 0), ie(4 === t.length && 2 === t[0].length && 2 === t[1].length && 2 === t[2].length && 2 === t[3].length, (function() {
				return "Invalid number of paddings. Must be length of 2 each."
			})), Za(e, t, n)
		}
	});
	...
	var eo = fn({
		pool_: function(e, t, n, r, a, o, s) {
			...
			var i = ln(e, "x", "maxPool"),
				u = i,
				c = !1;
			3 === i.rank && (c = !0, u = Vn(i, [1, i.shape[0], i.shape[1], i.shape[2]])), ie(Rn(o, a), (function() {
			...
			var o = ln(e, "shape", "raggedTensorToTensor", "int32"),
				...
				i = {
					...
					rowPartitionTensors: r.map((function(e, t) {
						return ln(e, "tensors".concat(t), "raggedTensorToTensor", "int32")
					}))
				},
				u = {
					rowPartitionTypes: a
		...
		! function(e, t, n) {
			...
			function o(e, t) {
				...
				return s.double = function() {
					...
					return e
				}, s.int32 = n.next, s.quick = s, o && ("object" == typeof o && a(o, n), s.state = function() {
					return a(n, {})
				}), s
			}
			t && t.exports ? t.exports = o : n && n.amd ? n((function() {
			...
			function r(e) {
				...
				t.next = function() {
						var e, n, r = t.w,
							a = t.X,
							o = t.i;
						return t.w = r = r + 1640531527 | 0, n = a[o + 34 & 127], e = a[o = o + 1 & 127], n ^= n << 13, e ^= e << 17, n ^= n >>> 15, e ^= e >>> 12, n = a[o] = n ^ e, t.i = o, n + (r ^ r >>> 16) | 0
					},
					function(e, t) {
						var n, r, a, o, s, i = [],
							u = 128;
						for (t === (0 | t) ? (r = t, t = null) : (t += "\0", r = 0, u = Math.max(u, t.length)), a = 0, o = -32; o < u; ++o) t && (r ^= t.charCodeAt((o + 32) % t.length)), 0 === o && (s = r), r ^= r << 10, r ^= r >>> 15, r ^= r << 4, r ^= r >>> 13, o >= 0 && (s = s + 1640531527 | 0, a = 0 == (n = i[127 & o] ^= r + s) ? a + 1 : 0);
						for (a >= 128 && (i[127 & (t && t.length || 0)] = -1), a = 127, o = 512; o > 0; --o) r = i[a + 34 & 127], n = i[a = a + 1 & 127], r ^= r << 13, n ^= n << 17, r ^= r >>> 15, n ^= n >>> 12, i[a] = r ^ n;
						e.w = s, e.X = i, e.i = a
					}(t, e)
			}
	...
	! function(e) {
		! function(t, n, r) {
			...
			function p(e, c, p) {
				var y = [],
					v = f(h((c = 1 == c ? {
						...
						try {
							var e;
							return a && (e = a.randomBytes) ? e = e(o) : (e = new Uint8Array(o), (t.crypto || t.msCrypto).getRandomValues(e)), m(e)
						} catch (e) {
							var r = t.navigator,
								s = r && r.plugins;
			...
			function l(e) {
				...
				(r.g = function(e) {
					for (var t, n = 0, a = r.i, s = r.j, i = r.S; e--;) t = i[a = c & a + 1], n = n * o + i[c & (i[a] = i[s = c & s + t]) + (i[s] = t)];
	...
	var Oo = Io,
		Ao = function() {
			...
			return e.prototype.nextValue = function() {
				...
				for (var t, n, r = !1; !r;) {
					...
					t = this.mean + this.stdDev * a * i, n = this.mean + this.stdDev * o * i, this.truncated && !this.isValidTruncated(t) || (r = !0)
				}
		...
		Do = function() {
			function e(e, t, n, r) {
				...
				var a = r || Math.random();
				this.randu = Oo.alea(a.toString()), this.randn = new Ao(0, 1, n, !1, this.randu()), this.d = e < 1 ? e + 2 / 3 : e - 1 / 3, this.c = 1 / Math.sqrt(9 * this.d)
			}
			return e.prototype.nextValue = function() {
				for (var e, t, n, r, a, o;;) {
					do {
					...
					if (o *= o * o, t = 1 - .331 * (e = r * r) * e, n = .5 * e + this.d * (1 - o + Math.log(o)), (a = this.randu()) < t || Math.log(a) < n) break
				}
	...
	var Co = fn({
		randomGamma_: function(e, t, n, r, a) {
			if (void 0 === n && (n = 1), void 0 === r && (r = "float32"), Se(e), null == n && (n = 1), null == r && (r = "float32"), "float32" !== r && "int32" !== r) throw new Error("Unsupported data type ".concat(r));
			for (var o = new Do(t, n, r, a), s = ar(e, r), i = 0; i < s.values.length; i++) s.values[i] = o.nextValue();
			return s.toTensor()
		}
	});
	var Fo = fn({
		randomNormal_: function(e, t, n, r, a) {
			if (void 0 === t && (t = 0), void 0 === n && (n = 1), Se(e), null != r && "bool" === r) throw new Error("Unsupported data type ".concat(r));
			for (var o = new Ao(t, n, r, !1, a), s = ar(e, r), i = 0; i < s.values.length; i++) s.values[i] = o.nextValue();
			return s.toTensor()
		}
	});
	var Ro = fn({
	...
	var zo = fn({
		randomUniform_: function(e, t, n, r, a) {
			void 0 === t && (t = 0), void 0 === n && (n = 1), void 0 === r && (r = "float32"), Se(e);
			for (var o = ar(e, r), s = new Mo(t, n, null, a), i = 0; i < o.values.length; i++) o.values[i] = s.nextValue();
			return o.toTensor()
		}
	});
	var Lo = fn({
	...
	var Yo = fn({
		separableConv2d_: function(e, t, n, r, a, o, s) {
			...
			var i = ln(e, "x", "separableConv2d"),
				...
				p = i,
				l = !1;
			if (3 === i.rank && (l = !0, p = Vn(i, [1, i.shape[0], i.shape[1], i.shape[2]])), "NCHW" === s) throw new Error("separableConv2d currently does not support dataFormat NCHW; only NHWC is supported");
			ie(4 === p.rank, (function() {
				return "Error in separableConv2d: input must be rank 4, but got " + "rank ".concat(p.rank, ".")
			})), ie(4 === u.rank, (function() {
			...
			ie(c.shape[2] === d * h, (function() {
				return "Error in separableConv2d: the third dimension of pointwise filter " + "must be ".concat(d * h, ", ") + "but got ".concat(c.shape[2], ".")
			}));
	...
	var Jo = function(e, t) {
		return c(this, void 0, void 0, (function() {
			...
			return p(this, (function(p) {
				switch (p.label) {
					case 0:
						return n = ln(e, "x", "setdiff1d"), r = ln(t, "y", "setdiff1d"), ie(n.dtype === r.dtype, (function() {
					...
					case 2:
						for (o = p.sent(), s = new Set(o), i = 0, l = 0; l < a.length; l++) s.has(a[l]) || i++;
						for (u = new Pt([i], n.dtype), c = new Pt([i], "int32"), l = 0, d = 0; l < a.length; l++) s.has(a[l]) || (u.values[d] = a[l], c.values[d] = l, d++);
	...
	var hs = fn({
		squeeze_: function(e, t) {
			...
			return Vn(n, function(e, t) {
				for (var n = [], r = [], a = null != t && Array.isArray(t) && 0 === t.length, o = null == t || a ? null : fe(t, e).sort(), s = 0, i = 0; i < e.length; ++i) {
					if (null != o) {
						if (o[s] === i && 1 !== e[i]) throw new Error("Can't squeeze axis ".concat(i, " since its dim '").concat(e[i], "' is not 1"));
						(null == o[s] || o[s] > i) && 1 === e[i] && (n.push(e[i]), r.push(i)), o[s] <= i && s++
					}
	...
	var ys = fn({
		stridedSlice_: function(e, t, n, r, a, o, s, i, u) {
			void 0 === a && (a = 0), void 0 === o && (o = 0), void 0 === s && (s = 0), void 0 === i && (i = 0), void 0 === u && (u = 0);
			var c = {
	...
	function xs(e, t, n) {
		if (ce(e), null != t && 2 !== t.length) throw new Error("tensor2d() requires shape to have two numbers");
		var r = un(e, n);
	...
	function Ns(e, t, n) {
		...
		if (0 === n.length) {
			...
			for (var s = 0; s < a; ++s)
				if (n.shape[s] !== t.shape[s]) throw new Error(o + " updates.shape[".concat(s, "] (").concat(n.shape[s], ") != indices.shape[").concat(s, "] (").concat(t.shape[s], ")."));
			for (s = 0; s < n.rank - a; ++s)
				if (n.shape[s + a] !== e[s + r]) throw new Error(o + " updates.shape[".concat(s + a, "] (").concat(n.shape[s + a], ") != shape[").concat(s + a, "] (").concat(e[s + a], ")"))
		}(n, t, e)
	}
	var ws = fn({
		tensorScatterUpdate_: function(e, t, n) {
			...
			if (Ns(o, a, r.shape), r.dtype !== o.dtype) throw new Error("tensor and updates must have the same dtype, instead they are ".concat(r.dtype, " and ").concat(o.dtype, "."));
			var s = {
				tensor: r,
				indices: a,
				updates: o
	...
	var Ts = fn({
		truncatedNormal_: function(e, t, n, r, a) {
			if (void 0 === t && (t = 0), void 0 === n && (n = 1), Se(e), null != r && "bool" === r) throw new Error("Unsupported data type $ { dtype }");
			for (var o = new Ao(t, n, r, !0, a), s = ar(e, r), i = 0; i < s.values.length; i++) s.values[i] = o.nextValue();
			return s.toTensor()
		}
	});
	var Ss = fn({
	...
	var Is = function(e) {
		return c(this, void 0, void 0, (function() {
			...
			return p(this, (function(a) {
				switch (a.label) {
					case 0:
						return [4, (t = ln(e, "condition", "whereAsync", "bool")).data()];
					case 1:
	...
	var Os = function(e, t, n) {
		return c(this, void 0, void 0, (function() {
			...
			return p(this, (function(p) {
				switch (p.label) {
					case 0:
						for (r = ln(e, "tensor", "boolMask"), a = ln(t, "mask", "boolMask", "bool"), o = null == n ? 0 : n, s = a.rank, i = r.shape, ie(s > 0, (function() {
								return "mask cannot be scalar"
							})), ue(i.slice(o, o + s), a.shape, "mask's shape must match the first K dimensions of tensor's shape,"), u = 1, c = o; c < o + s; c++) u *= i[c];
						return l = i.slice(0, o).concat([u], i.slice(o + s)), d = Vn(r, l), h = Vn(a, [-1]), [4, Is(h)];
					case 1:
						return f = p.sent(), m = hs(f, [1]), y = oa(d, m, o), e !== r && r.dispose(), t !== a && a.dispose(), m.dispose(), d.dispose(), h.dispose(), f.dispose(), [2, y]
				}
			}))
		}))
	};
	...
	var Ds = fn({
		movingAverage_: function(e, t, n, r, a) {
			...
			s = u, ie((o = i).dtype === s.dtype, (function() {
				return "The dtypes of the first(".concat(o.dtype, ") and") + " second(".concat(s.dtype, ") input must match")
	...
	var Cs = fn({
		sparseToDense_: function(e, t, n, r) {
			...
			! function(e, t, n, r) {
				...
				if (n.length !== o) throw new Error("outputShape has incorrect number of elements:," + " ".concat(n.length, ", should be: ").concat(o, "."));
				var s = t.size;
				if (0 !== t.rank && (1 !== t.rank || s !== a)) throw new Error("sparseValues has incorrect shape " + "".concat(t.shape, ", should be [] or [").concat(a, "]"));
	...
	var Vs = function(e, t, n) {
		return void 0 === n && (n = 1), c(this, void 0, void 0, (function() {
			...
			return p(this, (function(p) {
				switch (p.label) {
					case 0:
						return r = ln(e, "predictions", "inTopK"), a = ln(t, "targets", "inTopK"), ie(r.rank > 1, (function() {
							return "inTopK() expects the predictions to be of rank 2 or higher, " + "but got ".concat(r.rank)
						})), ie(r.rank - 1 === a.rank, (function() {
							return "predictions rank should be 1 larger than targets rank, but got predictions rank " + "".concat(r.rank, " and targets rank ").concat(a.rank)
						})), ue(r.shape.slice(0, r.shape.length - 1), a.shape, "predictions's shape should be align with the targets' shape, except the last dimension."), o = r.shape[r.shape.length - 1], ie(n > 0 && n <= o, (function() {
							return "'k' passed to inTopK() must be > 0 && <= the predictions last " + "dimension (".concat(o, "), but got ").concat(n)
						})), [4, r.data()];
					case 1:
						return s = p.sent(), [4, a.data()];
					case 2:
						for (i = p.sent(), u = d([s.length / o, o], 2), c = u[0], l = u[1], h = function(e, t) {
								return me(e, t)
							}("bool", c), f = 0; f < c; f++) {
							for (m = f * l, y = s.subarray(m, m + l), v = [], g = 0; g < y.length; g++) v.push({
								value: y[g],
								index: g
							});
						...
						return e !== r && r.dispose(), t !== a && a.dispose(), [2, gs(h, a.shape, "bool")]
				}
			}))
		}))
	};
	var Ps = fn({
		conv2DBackpropFilter_: function(e, t, n, r, a, o, s) {
			...
			var u = t;
			3 === u.rank && (u = Vn(t, [1, t.shape[0], t.shape[1], t.shape[2]])), ie(4 === i.rank, (function() {
			...
			ie(c === n[2], (function() {
				...
				return "Error in conv2dDerFilter: depth of dy (".concat(p, ") must ") + "match output depth for filter (".concat(n[3], ").")
	...
	var Us = fn({
		fusedConv2d_: function(e) {
			...
			if (f = f || "linear", !1 === qs(on.state.gradientDepth, f)) {
				ie("NHWC" === i, (function() {
					return "Error in fused conv2d: got dataFormat of ".concat(i, " but ") + "only NHWC is currently supported for the case of gradient depth is 0 and the activation is not linear."
				}));
			...
			var g = ln(n, "x", "conv2d", "float32"),
				...
				x = g,
				N = !1;
			3 === g.rank && (N = !0, x = Vn(g, [1, g.shape[0], g.shape[1], g.shape[2]])), ie(4 === x.rank, (function() {
				return "Error in fused conv2d: input must be rank 4, but got rank " + "".concat(x.rank, ".")
			})), ie(4 === b.rank, (function() {
				return "Error in fused conv2d: filter must be rank 4, but got rank " + "".concat(b.rank, ".")
			})), Ln("fused conv2d", o, p);
			var w = "NHWC" === i ? x.shape[3] : x.shape[1];
			ie(b.shape[2] === w, (function() {
				return "Error in conv2d: depth of input (".concat(w, ") must match ") + "input depth for filter ".concat(b.shape[2], ".")
			})), ie(Rn(a, c), (function() {
			...
			if (null != l && (t = d($t(k = ln(l, "bias", "fused conv2d"), g), 1), k = t[0], "NHWC" === i ? Dr(S.outShape, k.shape) : (ie(k.shape.length <= 1, (function() {
				...
				})), ie(0 === k.shape.length || k.shape[0] === S.outChannels || 1 === k.shape[0], (function() {
					return "Error in fused conv2d: bias shape (".concat(k.shape, ") is not ") + "compatible with the number of output channels " + "(".concat(S.outChannels, ")")
				})))), null != m) {
				var _ = m.shape;
				if (ie(_.length <= 1 || 3 === _.length, (function() {
						return "Error in fused conv2d: only supports scalar, 1-D Tensor or 3-D Tensor PReLU activation weights but got a tensor of " + "rank-".concat(_.length, ".")
					})), 1 === _.length) ie(1 === _[0] || _[0] === S.outChannels, (function() {
					return "Error in fused conv2d: PReLU activation weights " + "(".concat(_, ") is not compatible with the number of output ") + "channels (".concat(S.outChannels, ").")
				}));
				else if (3 === _.length) try {
					Dr(_, S.outShape)
				} catch (e) {
					var E = "Error in fused conv2d: PReLU activation weights (".concat(_, ") ") + "is not compatible with the output shape of the conv2d " + "(".concat(S.outShape, ").");
					throw Error(E)
				}
			...
			var I = function(e, t) {
					ie("NHWC" === i, (function() {
						return "Error in gradient of fused conv2D: got dataFormat of ".concat(i, " but only NHWC is currently supported.")
					}));
					var n = d(t, 4),
						r = n[0],
						s = n[1],
			...
			if (null == l) {
				var D = ga((function(e, t, n) {
					...
					return n([t, e, r]), N && (r = Vn(r, [r.shape[1], r.shape[2], r.shape[3]])), {
						value: r,
						gradFunc: I
					}
				}));
			...
			var M = ga((function(e, t, n, r) {
				...
				return r([t, e, a, n]), N && (a = Vn(a, [a.shape[1], a.shape[2], a.shape[3]])), {
					value: a,
					gradFunc: I
				}
			}));
	...
	var Hs = fn({
		fusedDepthwiseConv2d_: function(e) {
			...
			var g = ln(n, "x", "depthwiseConv2d", "float32"),
				...
				N = !1;
			3 === g.rank && (N = !0, x = Vn(g, [1, g.shape[0], g.shape[1], g.shape[2]])), ie(4 === x.rank, (function() {
				return "Error in fused depthwiseConv2d: input must be rank 4, but got " + "rank ".concat(x.rank, ".")
			})), ie(4 === b.rank, (function() {
				return "Error in fused depthwiseConv2d: filter must be rank 4, " + "but got rank ".concat(b.rank, ".")
			})), ie(x.shape[3] === b.shape[2], (function() {
				return "Error in fused depthwiseConv2d: number of input channels " + "(".concat(x.shape[3], ") must match the inChannels dimension in ") + "filter ".concat(b.shape[2], ".")
			...
			null != l && (t = d($t(w = ln(l, "bias", "fused conv2d"), g), 1), w = t[0], Dr(T.outShape, w.shape)), null != m && (k = ln(m, "prelu weights", "fused depthwiseConv2d"));
			var S = function(e, t) {
					ie(Fn(c), (function() {
		...
		matMul: fn({
			fusedMatMul_: function(e) {
				...
				var g = o ? y.shape[y.rank - 2] : y.shape[y.rank - 1],
					...
					S = pe(k);
				ie(g === b, (function() {
					return "Error in fused matMul: inner shapes (".concat(g, ") and (") + "".concat(b, ") of Tensors with shapes ").concat(y.shape, " and ") + "".concat(v.shape, " and transposeA=").concat(o) + " and transposeB=".concat(i, " must match.")
				}));
				var _, E, I = Dr(y.shape.slice(0, -2), v.shape.slice(0, -2)).concat([x, N]),
					O = Vn(y, o ? [T, g, x] : [T, x, g]),
					A = Vn(v, i ? [S, N, b] : [S, b, N]);
				null != u && (_ = d($t(_ = ln(u, "bias", "fused matMul"), y), 1)[0], Dr(I, _.shape)), null != l && (E = ln(l, "prelu weights", "fused matMul"));
				var D = function(e, t) {
						var n, r, a = d(t, 4),
							s = a[0],
							c = a[1],
						...
						return o || i ? !o && i ? (n = qn(f, c, !1, !1), r = qn(f, s, !0, !1)) : o && !i ? (n = qn(c, f, !1, !0), r = qn(s, f, !1, !1)) : (n = qn(c, f, !0, !0), r = qn(f, s, !0, !0)) : (n = qn(f, c, !1, !0), r = qn(s, f, !0, !1)), null != u ? [n, r, Ks(h, f)] : [n, r]
					},
					M = {
						a: O,
						b: A,
	...
	var $s = fn({
		cropAndResize_: function(e, t, n, r, a, o) {
			...
			ie(4 === s.rank, (function() {
				return "Error in cropAndResize: image must be rank 4," + "but got rank ".concat(s.rank, ".")
	...
	function ai(e, t, n, r, a, o) {
		...
		return n = Math.min(n, s), ie(0 <= r && r <= 1, (function() {
			...
			return "scores has incompatible shape with boxes. Expected ".concat(s, ", ") + "but was ".concat(t.shape[0])
		})), ie(0 <= o && o <= 1, (function() {
	...
	function ui(e, t, n, r, a, o, s, i, u) {
		...
		for (var l = o > 0 ? -.5 / o : 0, f = [], m = []; f.length < n && c.length > 0;) {
			...
			y.suppressBeginIndex = f.length, x || (y.score === v ? (f.push(g), m.push(y.score)) : y.score > a && si(c, y, li))
		}
		var k = f.length,
			T = n - k;
		i && T > 0 && (f.push.apply(f, h([], d(new Array(T).fill(0)), !1)), m.push.apply(m, h([], d(new Array(T).fill(0)), !1)));
		var S = {
			selectedIndices: f
		};
	...
	var di = function(e, t, n, r, a) {
		return void 0 === r && (r = .5), void 0 === a && (a = Number.NEGATIVE_INFINITY), c(this, void 0, void 0, (function() {
			var o, s, i, u, c, l, d;
			return p(this, (function(p) {
				switch (p.label) {
					case 0:
						return o = ln(e, "boxes", "nonMaxSuppressionAsync"), s = ln(t, "scores", "nonMaxSuppressionAsync"), i = ai(o, s, n, r, a), n = i.maxOutputSize, r = i.iouThreshold, a = i.scoreThreshold, [4, Promise.all([o.data(), s.data()])];
					case 1:
						return u = p.sent(), c = u[0], l = u[1], d = function(e, t, n, r, a) {
							return ui(e, t, n, r, a, 0)
						}(c, l, n, r, a).selectedIndices, o !== e && o.dispose(), s !== t && s.dispose(), [2, bs(d, "int32")]
				}
			}))
		}))
	};
	var hi = fn({
		nonMaxSuppressionWithScore_: function(e, t, n, r, a, o) {
			void 0 === r && (r = .5), void 0 === a && (a = Number.NEGATIVE_INFINITY), void 0 === o && (o = 0);
	...
	var fi = function(e, t, n, r, a, o) {
		return void 0 === r && (r = .5), void 0 === a && (a = Number.NEGATIVE_INFINITY), void 0 === o && (o = 0), c(this, void 0, void 0, (function() {
			var s, i, u, c, l, d, h, f, m;
			return p(this, (function(p) {
				switch (p.label) {
					case 0:
						return s = ln(e, "boxes", "nonMaxSuppressionAsync"), i = ln(t, "scores", "nonMaxSuppressionAsync"), u = ai(s, i, n, r, a, o), n = u.maxOutputSize, r = u.iouThreshold, a = u.scoreThreshold, o = u.softNmsSigma, [4, Promise.all([s.data(), i.data()])];
					case 1:
						return c = p.sent(), l = c[0], d = c[1], h = function(e, t, n, r, a, o) {
							return ui(e, t, n, r, a, o, !0)
						}(l, d, n, r, a, o), f = h.selectedIndices, m = h.selectedScores, s !== e && s.dispose(), i !== t && i.dispose(), [2, {
	...
	var mi = fn({
		nonMaxSuppressionPadded_: function(e, t, n, r, a, o) {
			void 0 === r && (r = .5), void 0 === a && (a = Number.NEGATIVE_INFINITY), void 0 === o && (o = !1);
			var s = ln(e, "boxes", "nonMaxSuppression"),
				i = ln(t, "scores", "nonMaxSuppression"),
				u = ai(s, i, n, r, a, null),
				c = {
	...
	var yi = function(e, t, n, r, a, o) {
		return void 0 === r && (r = .5), void 0 === a && (a = Number.NEGATIVE_INFINITY), void 0 === o && (o = !1), c(this, void 0, void 0, (function() {
			var s, i, u, c, l, h, f, m, y, v, g, b;
			return p(this, (function(p) {
				switch (p.label) {
					case 0:
						return s = ln(e, "boxes", "nonMaxSuppressionAsync"), i = ln(t, "scores", "nonMaxSuppressionAsync"), u = ai(s, i, n, r, a, null), c = u.maxOutputSize, l = u.iouThreshold, h = u.scoreThreshold, [4, Promise.all([s.data(), i.data()])];
					case 1:
						return f = d.apply(void 0, [p.sent(), 2]), m = f[0], y = f[1], v = function(e, t, n, r, a, o) {
							return ui(e, t, n, r, a, 0, !1, o, !0)
						}(m, y, c, l, h, o), g = v.selectedIndices, b = v.validOutputs, s !== e && s.dispose(), i !== t && i.dispose(), [2, {
	...
	var bi = fn({
		threshold_: function(e, t, n, r) {
			...
			if (ie(3 === c.rank, (function() {
					return "Error in threshold: image must be rank 3," + "but got rank ".concat(c.rank, ".")
				})), ie(3 === c.shape[2] || 1 === c.shape[2], (function() {
					return "Error in threshold: image color channel must be equal to 3 or 1" + "but got ".concat(c.shape[2], ".")
				})), ie("int32" === c.dtype || "float32" === c.dtype, (function() {
					return "Error in dtype: image dtype must be int32 or float32," + "but got dtype ".concat(c.dtype, ".")
			...
			"otsu" === t && (l = function(e, t) {
				for (var n, r, a, o, s, i, u = bs([-1]), c = bs([0]), p = bs([0]), l = 0; l < e.size - 1; l++) {
					n = Gn(e, 0, l + 1), r = Gn(e, l + 1), s = Ar(Qr(n), t), i = Ar(Qr(r), t);
	...
	var xi = fn({
		transform_: function(e, t, n, r, a, o) {
			...
			ie(4 === s.rank, (function() {
				return "Error in transform: image must be rank 4," + "but got rank ".concat(s.rank, ".")
			})), ie(2 === i.rank && (i.shape[0] === s.shape[0] || 1 === i.shape[0]) && 8 === i.shape[1], (function() {
	...
	var Ni = fn({
		bandPart_: function(e, t, n) {
			...
			})), a = ln(t < 0 ? u : t, "numLower", "bandPart")) : (ie("int32" === t.dtype, (function() {
				return "bandPart(): numLower's dtype must be an int32."
			})), a = Cr(ha(t, 0), u, Va(t, u))), "number" == typeof n ? (ie(n % 1 == 0, (function() {
			...
			})), o = ln(n < 0 ? c : n, "numUpper", "bandPart")) : (ie("int32" === n.dtype, (function() {
			...
			for (var n = e.shape[0], r = e.shape[1], a = ra(n), o = Kn(e), s = xs([
					...
					t = d(on.tidy((function() {
						var t = Gn(o, [e, e], [n - e, 1]),
							...
							l = wa(c, Un(p, u)),
							d = Ar(t, l);
						i = 1 === d.shape[0] ? Kn(s) : jn([s, Gn(d, [1, 0], [d.shape[0] - 1, d.shape[1]])], 0);
						...
						return [i, o, a]
					})), 3), i = t[0], o = t[1], a = t[2], en([u, c, p]).forEach((function(e) {
						return e.dispose()
					}))
				}, p = 0; p < u; ++p) c(p);
	...
	var Ei = fn({
		absoluteDifference_: function(e, t, n, r) {
			...
			var a = ln(e, "labels", "absoluteDifference"),
				...
				s = null;
			null != n && (s = ln(n, "weights", "absoluteDifference")), ue(a.shape, o.shape, "Error in absoluteDifference: ");
			var i = mn(wa(a, o));
			return _i(i, s, r)
		}
	});
	var Ii = fn({
		cosineDistance_: function(e, t, n, r, a) {
			...
			var o = ln(e, "labels", "cosineDistance"),
				...
				i = null;
			null != r && (i = ln(r, "weights", "cosineDistance")), ue(o.shape, s.shape, "Error in cosineDistance: ");
			var u = Gr(1),
	...
	var Oi = fn({
		hingeLoss_: function(e, t, n, r) {
			...
			var a = ln(e, "labels", "hingeLoss"),
				...
				s = null;
			null != n && (s = ln(n, "weights", "hingeLoss")), ue(a.shape, o.shape, "Error in hingeLoss: ");
			var i = Gr(1);
			a = wa(Un(Gr(2), a), i);
	...
	var Ai = fn({
		huberLoss_: function(e, t, n, r, a) {
			...
			var o = ln(e, "labels", "huberLoss"),
				...
				i = null;
			null != n && (i = ln(n, "weights", "huberLoss")), ue(o.shape, s.shape, "Error in huberLoss: ");
			var u = Gr(r),
				c = mn(wa(s, o)),
				p = Va(c, u),
				l = wa(c, p),
	...
	var Di = fn({
		logLoss_: function(e, t, n, r, a) {
			...
			var o = ln(e, "labels", "logLoss"),
				...
				i = null;
			null != n && (i = ln(n, "weights", "logLoss")), ue(o.shape, s.shape, "Error in logLoss: ");
			var u = Gr(1),
				c = Gr(r),
				p = ba(Un(o, ya(gn(s, c)))),
	...
	var Mi = fn({
		meanSquaredError_: function(e, t, n, r) {
			...
			var a = ln(e, "labels", "meanSquaredError"),
				...
				s = null;
			null != n && (s = ln(n, "weights", "meanSquaredError")), ue(a.shape, o.shape, "Error in meanSquaredError: ");
			var i = ds(a, o);
			return _i(i, s, r)
		}
	});
	var Ci = fn({
		sigmoidCrossEntropy_: function(e, t, n, r, a) {
			...
			var o = ln(e, "multiClassLabels", "sigmoidCrossEntropy"),
				...
				i = null;
			if (null != n && (i = ln(n, "weights", "sigmoidCrossEntropy")), ue(o.shape, s.shape, "Error in sigmoidCrossEntropy: "), r > 0) {
				var u = Gr(r),
					c = Gr(1),
					p = Gr(.5);
	...
	var Fi = fn({
		softmaxCrossEntropy_: function(e, t, n, r, a) {
			...
			var o = ln(e, "onehotLabels", "softmaxCrossEntropy"),
				...
				i = null;
			if (null != n && (i = ln(n, "weights", "softmaxCrossEntropy")), ue(o.shape, s.shape, "Error in softmaxCrossEntropy: "), r > 0) {
				var u = Gr(r),
					c = Gr(1),
					p = Gr(o.shape[1]);
			...
			var l = function(e, t, n) {
				if (void 0 === n && (n = -1), -1 === n && (n = t.rank - 1), n !== t.rank - 1) throw Error("Softmax cross entropy along a non-last dimension is not yet " + "supported. Labels / logits was rank ".concat(t.rank, " ") + "and dim was ".concat(n));
					...
					return {
						...
						gradFunc: function(e, t) {
							var r = d(t, 2),
								...
								o = r[1],
								s = Kr(e.shape, [n]);
							return [Un(Vn(e, s), wa(On(a, "float32"), $r(o))), Un(Vn(e, s), wa($r(o), On(a, "float32")))]
						}
					}
				}));
				return r(e, t)
	...
	var Ri = fn({
		sparseFillEmptyRows_: function(e, t, n, r) {
			...
			if (1 !== s.rank) throw new Error("Dense shape should be Tensor1D but received shape ".concat(s.shape));
	...
	var Bi = {
		...
		meshgrid: function(e, t, n) {
			...
			var s = ln(t, "y", "meshgrid", t instanceof jt ? t.dtype : "float32"),
				i = pe(o.shape),
				u = pe(s.shape);
			return "xy" === a ? (o = Vn(o, [1, -1]), s = Vn(s, [-1, 1]), [qn(La([u, 1], o.dtype), o), qn(s, La([1, i], s.dtype))]) : (o = Vn(o, [-1, 1]), s = Vn(s, [1, -1]), [qn(o, La([1, u], o.dtype)), qn(La([i, 1], s.dtype), s)])
		},
		min: qr,
		minimum: Va,
		mirrorPad: Pa,
		...
		tensor3d: function(e, t, n) {
			if (ce(e), null != t && 3 !== t.length) throw new Error("tensor3d() requires shape to have three numbers");
			var r = un(e, n);
		...
		tensor4d: function(e, t, n) {
			if (ce(e), null != t && 4 !== t.length) throw new Error("tensor4d() requires shape to have four numbers");
			var r = un(e, n);
		...
		tensor5d: function(e, t, n) {
			if (ce(e), null != t && 5 !== t.length) throw new Error("tensor5d() requires shape to have five numbers");
			var r = un(e, n);
		...
		tensor6d: function(e, t, n) {
			if (ce(e), null != t && 6 !== t.length) throw new Error("tensor6d() requires shape to have six numbers");
			var r = un(e, n);
	...
	function Ui(e, t) {
		...
		for (var n = [], r = 0; r < e.length; ++r) {
			var a = e[r],
				o = t[r];
			if (a >= 0 && o >= 0 && a !== o) throw new Error("Incompatible shape during merge: ".concat(e, " vs. ").concat(t));
			n[r] = a >= 0 ? a : o
		}
		return n
	}
	var Wi = function() {
			function e(e, n, r, a, o, s, i) {
				this.name = e, this.dtype = n, this.maxSize = r, this.elementShape = a, this.identicalElementShapes = o, this.dynamicSize = s, this.clearAfterRead = i, this.tensors = [], this.closed_ = !1, this.idTensor = t.scalar(0), t.keep(this.idTensor)
			}
			return Object.defineProperty(e.prototype, "id", {
				...
				if (n.dtype !== this.dtype) throw new Error("TensorArray ".concat(this.name, ": Could not write to TensorArray index ").concat(e, ",\n          because the value dtype is ").concat(n.dtype, ", but TensorArray dtype is ").concat(this.dtype, "."));
				...
				if (r.written) throw new Error("TensorArray ".concat(this.name, ": Could not write to TensorArray index ").concat(e, ", because it has already been written."));
				...
				if (n && n !== this.dtype) throw new Error("TensorArray dtype is ".concat(this.dtype, " but gather requested dtype ").concat(n));
				...
				return Ki(this.elementShape, a[0].shape, "TensorArray shape mismatch: tensor array shape (".concat(this.elementShape, ") vs first tensor shape (").concat(a[0].shape, ")")), t.concat(a, 0)
			}, e.prototype.scatter = function(e, n) {
				if (n.dtype !== this.dtype) throw new Error("TensorArray dtype is ".concat(this.dtype, " but tensor has dtype ").concat(n.dtype));
				if (e.length !== n.shape[0]) throw new Error("Expected len(indices) == tensor.shape[0], but saw: ".concat(e.length, " vs. ").concat(n.shape[0]));
				var r = Math.max.apply(Math, h([], d(e), !1));
				if (!this.dynamicSize && r >= this.maxSize) throw new Error("Max index must be < array size (".concat(r, "  vs. ").concat(this.maxSize, ")"));
				...
				if (a !== n.shape[0]) throw new Error("Expected sum of lengths to be equal to\n          tensor.shape[0], but sum of lengths is\n        ".concat(a, ", and tensor's shape is: ").concat(n.shape));
		...
		Gi = function() {
			function e(e, n, r, a) {
				void 0 === a && (a = -1), this.tensors = e, this.elementShape = n, this.elementDtype = r, null != e && e.forEach((function(e) {
			...
			return Object.defineProperty(e.prototype, "id", {
				...
				var a = this;
				if (void 0 === r && (r = -1), n !== this.elementDtype) throw new Error("Invalid data types; op elements ".concat(n, ", but list elements ").concat(this.elementDtype));
				...
				if (Ki(e.shape, this.elementShape, "TensorList shape mismatch: "), this.maxNumElements === this.size()) throw new Error("Trying to push element into a full list.");
				...
				if (r !== this.elementDtype) throw new Error("Invalid data types; op elements ".concat(r, ", but list elements ").concat(this.elementDtype));
				...
				if (n.dtype !== this.elementDtype) throw new Error("Invalid data types; op elements ".concat(n.dtype, ", but list elements ").concat(this.elementDtype));
				...
				Ki(this.elementShape, n.shape, "TensorList shape mismatch: "), t.keep(n), null != this.tensors[e] && (this.tensors[e].kept = !1), this.tensors[e] = n
	...
	var Hi = function(e, n, r) {
		return c(void 0, void 0, void 0, (function() {
			var a, o, s, i, u, c, l, f, m, g, b, x, N, w, T, S, _, E, I, O, A, D, M, C, F, R, z, L, V, P, B, K, j, q, U, W, G, H, Z, Q, X, Y, J, $, ee, te, ne, re, ae, oe, se, ie, ue, ce, pe, le, de;
			return p(this, (function(he) {
				switch (he.label) {
					case 0:
						...
						return [3, 38];
					case 1:
						return a = y("thenBranch", e, n, r), o = y("elseBranch", e, n, r), s = y("cond", e, n, r), c = y("args", e, n, r), [4, s.data()];
					case 2:
						return (m = he.sent())[0] ? [2, r.functionMap[a].executeFunctionAsync(c, r.tensorArrayMap, r.tensorListMap)] : [2, r.functionMap[o].executeFunctionAsync(c, r.tensorArrayMap, r.tensorListMap)];
					case 3:
						return i = y("body", e, n, r), u = y("cond", e, n, r), c = y("args", e, n, r), [4, r.functionMap[u].executeFunctionAsync(c, r.tensorArrayMap, r.tensorListMap)];
					case 4:
					...
					case 5:
						m = he.sent(), l.forEach((function(e) {
							...
							return p(this, (function(a) {
								switch (a.label) {
									case 0:
										return e = g, [4, r.functionMap[i].executeFunctionAsync(g, r.tensorArrayMap, r.tensorListMap)];
									case 1:
										return g = a.sent(), t = g.map((function(e) {
											return e.id
										})), e.forEach((function(e) {
											e.kept || -1 !== f.indexOf(e.id) || -1 !== t.indexOf(e.id) || e.dispose()
										})), [4, r.functionMap[u].executeFunctionAsync(g, r.tensorArrayMap, r.tensorListMap)];
									case 2:
										return [4, (n = a.sent())[0].data()];
									case 3:
										return m = a.sent(), n.forEach((function(e) {
											e.kept || -1 !== f.indexOf(e.id) || -1 !== t.indexOf(e.id) || e.dispose()
										})), [2]
								}
							}))
					...
					case 10:
						return x = y("pred", e, n, r), (T = y("data", e, n, r)).kept || (T = k(T)), [4, x.data()];
					case 11:
					...
					case 13:
						return w = y("frameName", e, n, r), T = y("tensor", e, n, r), r.enterFrame(w), [2, [k(T)]];
					case 14:
						return T = y("tensor", e, n, r), r.exitFrame(), [2, [k(T)]];
					case 15:
						return T = y("tensor", e, n, r), r.nextIteration(), [2, [k(T)]];
					case 16:
						return pe = y("size", e, n, r), S = y("dtype", e, n, r), se = y("elementShape", e, n, r), _ = y("dynamicSize", e, n, r), E = y("clearAfterRead", e, n, r), I = y("identicalElementShapes", e, n, r), O = y("name", e, n, r), A = new Wi(O, S, pe, se, I, _, E), r.addTensorArray(A), [2, [A.idTensor, t.scalar(1)]];
					case 17:
						return D = y("tensorArrayId", e, n, r), U = y("index", e, n, r), re = y("tensor", e, n, r), (M = r.getTensorArray(D.id)).write(U, re), [2, [M.idTensor]];
					case 18:
						return C = y("tensorArrayId", e, n, r), W = y("index", e, n, r), [2, [r.getTensorArray(C.id).read(W)]];
					case 19:
						return X = y("tensorArrayId", e, n, r), Y = y("indices", e, n, r), F = y("dtype", e, n, r), [2, [r.getTensorArray(X.id).gather(Y, F)]];
					case 20:
						return R = y("tensorArrayId", e, n, r), G = y("indices", e, n, r), H = y("tensor", e, n, r), (z = r.getTensorArray(R.id)).scatter(G, H), [2, [z.idTensor]];
					case 21:
						return te = y("tensorArrayId", e, n, r), L = r.getTensorArray(te.id), ne = y("dtype", e, n, r), [2, [L.concat(ne)]];
					case 22:
						return V = y("tensorArrayId", e, n, r), oe = y("tensor", e, n, r), ie = y("lengths", e, n, r), (P = r.getTensorArray(V.id)).split(ie, oe), [2, [P.idTensor]];
					case 23:
						return B = y("tensorArrayId", e, n, r), K = r.getTensorArray(B.id), [2, [t.scalar(K.size(), "int32")]];
					case 24:
						return j = y("tensorArrayId", e, n, r), (q = r.getTensorArray(j.id)).clearAndClose(), [2, [q.idTensor]];
					case 25:
						return ce = y("tensorListId", e, n, r), U = y("index", e, n, r), re = y("tensor", e, n, r), (ue = r.getTensorList(ce.id)).setItem(U, re), [2, [ue.idTensor]];
					case 26:
						return ce = y("tensorListId", e, n, r), W = y("index", e, n, r), se = y("elementShape", e, n, r), ae = y("elementDType", e, n, r), [2, [(ue = r.getTensorList(ce.id)).getItem(W, se, ae)]];
					case 27:
						return G = y("indices", e, n, r), H = y("tensor", e, n, r), se = y("elementShape", e, n, r), J = y("numElements", e, n, r), ue = function(e, n, r, a) {
							if (n.length !== e.shape[0]) throw new Error("Expected len(indices) == tensor.shape[0], but saw: ".concat(n.length, " vs. ").concat(e.shape[0]));
							var o = Math.max.apply(Math, h([], d(n), !1));
							if (null != a && -1 !== a && o >= a) throw new Error("Max index must be < array size (".concat(o, "  vs. ").concat(a, ")"));
					...
					case 28:
						return se = y("elementShape", e, n, r), ee = y("elementDType", e, n, r), Z = void 0, Z = "TensorListReserve" === e.op ? "numElements" : "maxNumElements", J = y(Z, e, n, r), Q = "TensorListReserve" === e.op ? -1 : J, ue = function(e, t, n, r) {
							return new Gi([], e, t, r)
						}(se, ee, 0, Q), r.addTensorList(ue), [2, [ue.idTensor]];
					case 29:
						return X = y("tensorListId", e, n, r), Y = y("indices", e, n, r), se = y("elementShape", e, n, r), ee = y("elementDType", e, n, r), [2, [(ue = r.getTensorList(X.id)).gather(Y, ee, se)]];
					case 30:
						return ce = y("tensorListId", e, n, r), se = y("elementShape", e, n, r), ee = y("elementDType", e, n, r), J = y("numElements", e, n, r), [2, [(ue = r.getTensorList(ce.id)).stack(se, ee, J)]];
					case 31:
						return $ = y("tensor", e, n, r), se = y("elementShape", e, n, r), ee = y("elementDType", e, n, r), ue = function(e, n, r) {
							var a = e.dtype;
							if (e.shape.length < 1) throw new Error("Tensor must be at least a vector, but saw shape: ".concat(e.shape));
							if (e.dtype !== r) throw new Error("Invalid data types; op elements ".concat(e.dtype, ", but list elements ").concat(r));
							Ki(e.shape.slice(1), n, "TensorList shape mismatch: ");
							var o = t.unstack(e);
							return new Gi(o, n, a)
						}($, se, ee), r.addTensorList(ue), [2, [ue.idTensor]];
					case 32:
						return te = y("tensorListId", e, n, r), ue = r.getTensorList(te.id), ne = y("dtype", e, n, r), se = y("elementShape", e, n, r), [2, [ue.concat(ne, se)]];
					case 33:
						return ce = y("tensorListId", e, n, r), re = y("tensor", e, n, r), (ue = r.getTensorList(ce.id)).pushBack(re), [2, [ue.idTensor]];
					case 34:
						return ce = y("tensorListId", e, n, r), se = y("elementShape", e, n, r), ae = y("elementDType", e, n, r), [2, [(ue = r.getTensorList(ce.id)).popBack(se, ae)]];
					case 35:
						return oe = y("tensor", e, n, r), se = y("elementShape", e, n, r), ie = y("lengths", e, n, r), ue = function(e, n, r) {
							var a = 0,
								o = n.map((function(e) {
									return a += e
								}));
							if (a !== e.shape[0]) throw new Error("Expected sum of lengths to be equal to\n          tensor.shape[0], but sum of lengths is\n        ".concat(a, ", and tensor's shape is: ").concat(e.shape));
							for (var s = Ui(e.shape.slice(1), r), i = 0 === a ? 0 : e.size / a, u = t.tidy((function() {
									var r = [];
									e = t.reshape(e, [1, a, i]);
									for (var u = 0; u < n.length; ++u) {
										var c = [0, 0 === u ? 0 : o[u - 1], 0],
											p = [1, n[u], i];
										r[u] = t.reshape(t.slice(e, c, p), s)
									}
									return e.dispose(), r
								})), c = new Gi([], r, e.dtype, n.length), p = 0; p < u.length; p++) c.setItem(p, u[p]);
							return c
						}(oe, ie, se), r.addTensorList(ue), [2, [ue.idTensor]];
					case 36:
						return ce = y("tensorListId", e, n, r), ue = r.getTensorList(ce.id), [2, [t.scalar(ue.size(), "int32")]];
					case 37:
						return ce = y("tensorListId", e, n, r), pe = y("size", e, n, r), le = r.getTensorList(ce.id), de = le.resize(pe), r.addTensorList(de), [2, [de.idTensor]];
					case 38:
	...
	function Zi(e, t, n) {
		var r = d(y("fusedOps", e, t, n), 2),
			...
			p = y("numArgs", e, t, n);
		if (s) {
			if (u && 2 !== p) throw new Error("FusedConv2d and DepthwiseConv2d with BiasAdd and Prelu must have two extra arguments: bias and alpha.");
			if (!u && s && 1 !== p) throw new Error("FusedConv2d and DepthwiseConv2d with BiasAdd must have one extra argument: bias.")
		}
	...
	var Xi = function() {
		function e(e, n) {
			this.keyDType = e, this.valueDType = n, this.handle = t.scalar(0), this.tensorMap = new Map, t.keep(this.handle)
		}
		return Object.defineProperty(e.prototype, "id", {
			get: function() {
			...
			return c(this, void 0, void 0, (function() {
				...
				return p(this, (function(o) {
					switch (o.label) {
						case 0:
							return this.checkKeyAndValueTensor(e, n), [4, e.data()];
						case 1:
							return r = o.sent(), this.tensorMap.forEach((function(e) {
								return e.dispose()
							})), this.tensorMap.clear(), [2, t.tidy((function() {
								var e = t.unstack(n),
									o = r.length,
									s = e.length;
								t.util.assert(o === s, (function() {
									return "The number of elements doesn't match, keys has " + "".concat(o, " elements, the values has ").concat(s, " ") + "elements."
								}));
								for (var i = 0; i < o; i++) {
									var u = r[i],
										c = e[i];
									t.keep(c), a.tensorMap.set(u, c)
								}
								return a.handle
							}))]
					}
						...
						return function(e, t, n, r) {
							switch (void 0 === r && (r = Bi), e.op) {
								...
								case "SquaredDifference":
									return [r.squaredDifference(y("a", e, t, n), y("b", e, t, n))];
								default:
									throw TypeError("Node type ".concat(e.op, " is not implemented"))
							}
						}(e, n, r)
					...
					return s((function() {
						return function(e, t, n, r) {
							switch (void 0 === r && (r = Bi), e.op) {
								...
								case "Complex":
									return [r.complex(y("real", e, t, n), y("imag", e, t, n))];
								case "Cos":
								...
								case "ClipByValue":
									return [r.clipByValue(y("x", e, t, n), y("clipValueMin", e, t, n), y("clipValueMax", e, t, n))];
								case "Relu6":
									return [r.relu6(y("x", e, t, n))];
								case "Rsqrt":
									return [r.rsqrt(v(e.inputNames[0], t, n))];
								case "LeakyRelu":
									return [r.leakyRelu(y("x", e, t, n), y("alpha", e, t, n))];
								case "Prelu":
							...
							switch (void 0 === r && (r = Bi), e.op) {
								case "Conv1D":
									var a = y("stride", e, t, n),
										...
										i = y("dilation", e, t, n);
									return [r.conv1d(y("x", e, t, n), y("filter", e, t, n), a, o, s, i)];
								case "Conv2D":
									a = y("strides", e, t, n), o = w(e, t, n), s = y("dataFormat", e, t, n).toUpperCase();
									var u = y("dilations", e, t, n);
									return [r.conv2d(y("x", e, t, n), y("filter", e, t, n), [a[1], a[2]], o, s, [u[1], u[2]])];
								case "_FusedConv2D":
									var c = Zi(e, t, n),
										p = (a = c.stride, o = c.pad, s = c.dataFormat, u = c.dilations, c.biasArg),
										l = c.preluArg,
										d = c.activationFunc,
										h = c.leakyreluAlpha;
								...
								case "FusedDepthwiseConv2dNative":
									var f = Zi(e, t, n);
									return a = f.stride, o = f.pad, s = f.dataFormat, u = f.dilations, p = f.biasArg, l = f.preluArg, d = f.activationFunc, h = f.leakyreluAlpha, [r.fused.depthwiseConv2d({
										x: y("x", e, t, n),
										filter: y("filter", e, t, n),
										strides: [a[1], a[2]],
										pad: o,
								...
								case "Conv2dTranspose":
									...
									return a = y("strides", e, t, n), o = w(e, t, n), [r.conv2dTranspose(y("x", e, t, n), y("filter", e, t, n), m, [a[1], a[2]], o)];
								case "DepthwiseConv2dNative":
								case "DepthwiseConv2d":
									return a = y("strides", e, t, n), o = w(e, t, n), u = y("dilations", e, t, n), s = y("dataFormat", e, t, n).toUpperCase(), [r.depthwiseConv2d(y("input", e, t, n), y("filter", e, t, n), [a[1], a[2]], o, s, [u[1], u[2]])];
								case "Conv3D":
									return a = y("strides", e, t, n), o = y("pad", e, t, n), s = y("dataFormat", e, t, n).toUpperCase(), u = y("dilations", e, t, n), [r.conv3d(y("x", e, t, n), y("filter", e, t, n), [a[1], a[2], a[3]], o, s, [u[1], u[2], u[3]])];
								case "AvgPool":
									a = y("strides", e, t, n), o = y("pad", e, t, n);
									var v = y("kernelSize", e, t, n);
									return [r.avgPool(y("x", e, t, n), [v[1], v[2]], [a[1], a[2]], o)];
								case "MaxPool":
									return a = y("strides", e, t, n), o = y("pad", e, t, n), v = y("kernelSize", e, t, n), [r.maxPool(y("x", e, t, n), [v[1], v[2]], [a[1], a[2]], o)];
								case "MaxPoolWithArgmax":
									a = y("strides", e, t, n), o = y("pad", e, t, n), v = y("kernelSize", e, t, n);
									var g = y("includeBatchInIndex", e, t, n),
										b = r.maxPoolWithArgmax(y("x", e, t, n), [v[1], v[2]], [a[1], a[2]], o, g);
									return [b.result, b.indexes];
								case "AvgPool3D":
									return a = y("strides", e, t, n), o = y("pad", e, t, n), v = y("kernelSize", e, t, n), [r.avgPool3d(y("x", e, t, n), [v[1], v[2], v[3]], [a[1], a[2], a[3]], o)];
								case "MaxPool3D":
									return a = y("strides", e, t, n), o = y("pad", e, t, n), v = y("kernelSize", e, t, n), [r.maxPool3d(y("x", e, t, n), [v[1], v[2], v[3]], [a[1], a[2], a[3]], o)];
								case "Dilation2D":
									var x = y("strides", e, t, n),
										N = (o = y("pad", e, t, n), u = y("dilations", e, t, n), x[1]),
										k = x[2],
										T = u[1],
										S = u[2];
									return [r.dilation2d(y("x", e, t, n), y("filter", e, t, n), [N, k], o, [T, S], "NHWC")];
								default:
									throw TypeError("Node type ".concat(e.op, " is not implemented"))
							}
						}(e, n, r)
							...
							switch (void 0 === r && (r = Bi), e.op) {
								...
								case "OneHot":
									var h = y("indices", e, t, n),
										...
										m = y("onValue", e, t, n),
										v = y("offValue", e, t, n);
									return o = y("dtype", e, t, n), [r.oneHot(h, f, m, v, o)];
								case "Ones":
									return [r.ones(y("shape", e, t, n), y("dtype", e, t, n))];
								case "OnesLike":
									return [r.onesLike(y("x", e, t, n))];
								case "RandomStandardNormal":
									return [r.randomStandardNormal(y("shape", e, t, n), y("dtype", e, t, n), y("seed", e, t, n))];
								case "RandomUniform":
									return [r.randomUniform(y("shape", e, t, n), y("minval", e, t, n), y("maxval", e, t, n), y("dtype", e, t, n))];
								case "RandomUniformInt":
									return [r.randomUniformInt(y("shape", e, t, n), y("minval", e, t, n), y("maxval", e, t, n), y("seed", e, t, n))];
								case "Range":
								...
								case "TruncatedNormal":
									...
									var b = y("mean", e, t, n),
										x = y("stdDev", e, t, n);
									return d = y("seed", e, t, n), [r.truncatedNormal(a, b, x, y("dtype", e, t, n), d)];
								case "Zeros":
									return [r.zeros(y("shape", e, t, n), y("dtype", e, t, n))];
								case "ZerosLike":
							...
							return p(this, (function(p) {
								switch (p.label) {
									case 0:
										...
										return [3, 10];
									case 1:
										return r = Qi(e, t, n), c = r.boxes, l = r.scores, d = r.maxOutputSize, h = r.iouThreshold, f = r.scoreThreshold, o = r.softNmsSigma, [4, a.image.nonMaxSuppressionWithScoreAsync(c, l, d, h, f, o)];
									case 2:
										return [2, [(v = p.sent()).selectedIndices, v.selectedScores]];
									case 3:
										return s = Qi(e, t, n), c = s.boxes, l = s.scores, d = s.maxOutputSize, h = s.iouThreshold, f = s.scoreThreshold, i = y("padToMaxOutputSize", e, t, n), [4, a.image.nonMaxSuppressionPaddedAsync(c, l, d, h, f, i)];
									case 4:
										return [2, [(v = p.sent()).selectedIndices, v.validOutputs]];
									case 5:
										return u = Qi(e, t, n), c = u.boxes, l = u.scores, d = u.maxOutputSize, h = u.iouThreshold, f = u.scoreThreshold, [4, a.image.nonMaxSuppressionAsync(c, l, d, h, f)];
									case 6:
										return [2, [p.sent()]];
									case 7:
										return m = a.cast(y("condition", e, t, n), "bool"), [4, a.whereAsync(m)];
									case 8:
										return v = [p.sent()], m.dispose(), [2, v];
									case 9:
										return [2, a.setdiff1dAsync(y("x", e, t, n), y("y", e, t, n))];
									case 10:
										throw TypeError("Node type ".concat(e.op, " is not implemented"))
								}
							}))
					...
					return s((function() {
						return function(e, t, n, r) {
							switch (void 0 === r && (r = Bi), e.op) {
								...
								case "UpperBound":
									return a = y("sortedSequence", e, t, n), o = y("values", e, t, n), [r.upperBound(a, o)];
								case "Unique":
									return s = y("x", e, t, n), [(c = r.unique(s)).values, c.indices];
								case "UniqueV2":
									s = y("x", e, t, n);
						...
						return function(e, t, n, r) {
							switch (void 0 === r && (r = Bi), e.op) {
								...
								case "ResizeNearestNeighbor":
									return a = y("images", e, t, n), o = y("size", e, t, n), s = y("alignCorners", e, t, n), i = y("halfPixelCenters", e, t, n), [r.image.resizeNearestNeighbor(a, [o[0], o[1]], s, i)];
								case "CropAndResize":
									var u = y("image", e, t, n),
										c = y("boxes", e, t, n),
										p = y("boxInd", e, t, n),
								...
								case "ImageProjectiveTransformV3":
									...
									var f = y("transforms", e, t, n),
										...
										b = y("fillMode", e, t, n);
									return [r.image.transform(a, f, g.toLowerCase(), b.toLowerCase(), v, m)];
								default:
									throw TypeError("Node type ".concat(e.op, " is not implemented"))
							}
						}(e, n, r)
						...
						return function(e, t, n, r) {
							switch (void 0 === r && (r = Bi), e.op) {
								...
								case "Print":
									...
									for (var c = 0; c < s.length; c++) console.log(Array.prototype.slice.call(s[c].dataSync()).slice(0, u));
									return [o];
								default:
									throw TypeError("Node type ".concat(e.op, " is not implemented"))
							}
					...
					return s((function() {
						return function(e, t, n, r) {
							switch (void 0 === r && (r = Bi), e.op) {
								...
								case "GreaterEqual":
									return [r.greaterEqual(y("a", e, t, n), y("b", e, t, n))];
								case "Less":
								...
								case "Select":
								case "SelectV2":
									return [r.where(y("condition", e, t, n), y("a", e, t, n), y("b", e, t, n))];
								case "BitwiseAnd":
					...
					return s((function() {
						return function(e, t, n, r) {
							switch (void 0 === r && (r = Bi), e.op) {
								...
								case "BatchMatMulV2":
								case "MatMul":
									return [r.matMul(y("a", e, t, n), y("b", e, t, n), y("transposeA", e, t, n), y("transposeB", e, t, n))];
								case "Einsum":
									return [r.einsum.apply(r, h([y("equation", e, t, n)], d(y("tensors", e, t, n)), !1))];
								case "Transpose":
									return [r.transpose(y("x", e, t, n), y("perm", e, t, n))];
								case "_FusedMatMul":
								...
								case "MatrixBandPart":
									return [r.linalg.bandPart(y("a", e, t, n), y("numLower", e, t, n), y("numUpper", e, t, n))];
								default:
									throw TypeError("Node type ".concat(e.op, " is not implemented"))
							}
						}(e, n, r)
				...
				case "normalization":
					return s((function() {
						return function(e, t, n, r) {
							switch (void 0 === r && (r = Bi), e.op) {
								case "EuclideanNorm":
									return [r.euclideanNorm(y("x", e, t, n), y("axis", e, t, n), y("keepDims", e, t, n))];
								case "FusedBatchNorm":
								case "FusedBatchNormV2":
								case "FusedBatchNormV3":
									return [r.batchNorm(y("x", e, t, n), y("mean", e, t, n), y("variance", e, t, n), y("offset", e, t, n), y("scale", e, t, n), y("epsilon", e, t, n))];
								case "LRN":
									return [r.localResponseNormalization(y("x", e, t, n), y("radius", e, t, n), y("bias", e, t, n), y("alpha", e, t, n), y("beta", e, t, n))];
								case "Softmax":
				...
				case "ragged":
					return s((function() {
						return function(e, t, n, r) {
							switch (void 0 === r && (r = Bi), e.op) {
								case "RaggedGather":
									var a = r.raggedGather(y("paramsNestedSplits", e, t, n), y("paramsDenseValues", e, t, n), y("indices", e, t, n), y("outputRaggedRank", e, t, n)),
										o = a.outputNestedSplits,
										s = a.outputDenseValues;
									return o.concat(s);
								case "RaggedRange":
									var i = r.raggedRange(y("starts", e, t, n), y("limits", e, t, n), y("splits", e, t, n));
									return [i.rtNestedSplits, i.rtDenseValues];
								case "RaggedTensorToTensor":
									return [r.raggedTensorToTensor(y("shape", e, t, n), y("values", e, t, n), y("defaultValue", e, t, n), y("rowPartitionTensors", e, t, n), y("rowPartitionTypes", e, t, n))];
								default:
									throw TypeError("Node type ".concat(e.op, " is not implemented"))
							}
						}(e, n, r)
					...
					return s((function() {
						return function(e, t, n, r) {
							switch (void 0 === r && (r = Bi), e.op) {
								...
								case "Mean":
									return a = y("axis", e, t, n), o = y("keepDims", e, t, n), [r.mean(y("x", e, t, n), a, o)];
								case "Min":
									return a = y("axis", e, t, n), o = y("keepDims", e, t, n), [r.min(y("x", e, t, n), a, o)];
								case "Sum":
									return a = y("axis", e, t, n), o = y("keepDims", e, t, n), [r.sum(y("x", e, t, n), a, o)];
								case "All":
									return a = y("axis", e, t, n), o = y("keepDims", e, t, n), [r.all(y("x", e, t, n), a, o)];
								case "Any":
									return a = y("axis", e, t, n), o = y("keepDims", e, t, n), [r.any(y("x", e, t, n), a, o)];
								case "ArgMax":
									return a = y("axis", e, t, n), [r.argMax(y("x", e, t, n), a)];
								case "ArgMin":
									return a = y("axis", e, t, n), [r.argMin(y("x", e, t, n), a)];
								case "Prod":
									return a = y("axis", e, t, n), o = y("keepDims", e, t, n), [r.prod(y("x", e, t, n), a, o)];
								case "Cumprod":
									a = y("axis", e, t, n);
								...
								case "Cumsum":
									return a = y("axis", e, t, n), s = y("exclusive", e, t, n), i = y("reverse", e, t, n), [r.cumsum(y("x", e, t, n), a, s, i)];
								case "Bincount":
									var u = y("x", e, t, n),
										c = y("weights", e, t, n),
										p = y("size", e, t, n);
						...
						return function(e, n, r, a) {
							switch (void 0 === a && (a = Bi), e.op) {
								...
								case "GatherV2":
									...
									return u = y("x", e, n, r), c = y("indices", e, n, r), [a.gather(u, a.cast(c, "int32"), s, p)];
								case "Reverse":
									for (var l = y("dims", e, n, r), d = (s = [], 0); d < l.length; d++) l[d] && s.push(d);
									return u = y("x", e, n, r), [a.reverse(u, s)];
								case "ReverseV2":
									return s = y("axis", e, n, r), u = y("x", e, n, r), [a.reverse(u, s)];
								case "Slice":
									var h = y("begin", e, n, r),
										f = y("size", e, n, r);
								...
								case "Pack":
									return t.tidy((function() {
										var o = y("axis", e, n, r),
											...
											c = s.map((function(e) {
												var n = t.util.arraysEqual(e.shape, i);
												if (!n && !t.util.arraysEqual(a.squeeze(e).shape, u)) throw new Error("the input tensors shape does not match");
												return n ? e : a.reshape(e, i)
											}));
										return [a.stack(c, o)]
									}));
								case "Unpack":
									return s = y("axis", e, n, r), k = y("tensor", e, n, r), a.unstack(k, s);
								case "Tile":
									var T = y("reps", e, n, r);
								...
								case "SparseToDense":
									c = y("sparseIndices", e, n, r), E = y("outputShape", e, n, r);
									var O = y("sparseValues", e, n, r),
										A = y("defaultValue", e, n, r);
									return [a.sparseToDense(c, O, E, O.dtype === A.dtype ? A : a.cast(A, O.dtype))];
								case "TensorScatterUpdate":
									return c = y("indices", e, n, r), _ = y("values", e, n, r), k = y("tensor", e, n, r), [a.tensorScatterUpdate(k, c, _)];
								default:
									throw TypeError("Node type ".concat(e.op, " is not implemented"))
							}
						}(e, n, r)
						...
						return function(e, t, n, r) {
							switch (void 0 === r && (r = Bi), e.op) {
								case "SparseFillEmptyRows":
									var a = r.sparse.sparseFillEmptyRows(y("indices", e, t, n), y("values", e, t, n), y("denseShape", e, t, n), y("defaultValue", e, t, n));
									return [a.outputIndices, a.outputValues, a.emptyRowIndicator, a.reverseIndexMap];
								case "SparseReshape":
									var o = r.sparse.sparseReshape(y("inputIndices", e, t, n), y("inputShape", e, t, n), y("newShape", e, t, n));
									return [o.outputIndices, o.outputShape];
								case "SparseSegmentMean":
									return [r.sparse.sparseSegmentMean(y("data", e, t, n), y("indices", e, t, n), y("segmentIds", e, t, n))];
								case "SparseSegmentSum":
									return [r.sparse.sparseSegmentSum(y("data", e, t, n), y("indices", e, t, n), y("segmentIds", e, t, n))];
								default:
									throw TypeError("Node type ".concat(e.op, " is not implemented"))
							}
						}(e, n, r)
						...
						return function(e, t, n, r) {
							switch (void 0 === r && (r = Bi), e.op) {
								case "StaticRegexReplace":
									return [r.string.staticRegexReplace(y("input", e, t, n), y("pattern", e, t, n), y("rewrite", e, t, n), y("replaceGlobal", e, t, n))];
								case "StringNGrams":
									var a = r.string.stringNGrams(y("data", e, t, n), y("dataSplits", e, t, n), y("separator", e, t, n), y("nGramWidths", e, t, n), y("leftPad", e, t, n), y("rightPad", e, t, n), y("padWidth", e, t, n), y("preserveShortSequences", e, t, n));
									return [a.nGrams, a.nGramsSplits];
								case "StringSplit":
									var o = r.string.stringSplit(y("input", e, t, n), y("delimiter", e, t, n), y("skipEmpty", e, t, n));
									return [o.indices, o.values, o.shape];
								case "StringToHashBucketFast":
									return [r.string.stringToHashBucketFast(y("input", e, t, n), y("numBuckets", e, t, n))];
								default:
									throw TypeError("Node type ".concat(e.op, " is not implemented"))
							}
						}(e, n, r)
					...
					return s((function() {
						return function(e, t, n, r) {
							switch (void 0 === r && (r = Bi), e.op) {
								...
								case "Squeeze":
									return a = y("axis", e, t, n), [r.squeeze(y("x", e, t, n), a)];
								case "Reshape":
									return [r.reshape(y("x", e, t, n), y("shape", e, t, n))];
								case "EnsureShape":
									return [r.ensureShape(y("x", e, t, n), y("shape", e, t, n))];
								case "MirrorPad":
									return [r.mirrorPad(y("x", e, t, n), y("padding", e, t, n), y("mode", e, t, n))];
								case "PadV2":
								case "Pad":
									return [r.pad(y("x", e, t, n), y("padding", e, t, n), y("constantValue", e, t, n))];
								case "SpaceToBatchND":
								...
								case "BroadcastTo":
									return [r.broadcastTo(y("x", e, t, n), y("shape", e, t, n))];
								case "BroadcastArgs":
									return [r.broadcastArgs(y("s0", e, t, n), y("s1", e, t, n))];
								default:
									throw TypeError("Node type ".concat(e.op, " is not implemented"))
							}
						}(e, n, r)
							...
							return p(this, (function(p) {
								switch (p.label) {
									case 0:
										...
										return [3, 7];
									case 1:
										return null != (a = r.getHashTableHandleByName(e.name)) ? [2, [a]] : (o = y("keyDType", e, t, n), s = y("valueDType", e, t, n), d = new Xi(o, s), r.addHashTable(e.name, d), [2, [d.handle]]);
									case 2:
										return l = y("tableHandle", e, t, n, r), u = y("keys", e, t, n), i = y("values", e, t, n), [4, (d = r.getHashTableById(l.id)).import(u, i)];
									case 3:
									case 5:
										return [2, [p.sent()]];
									case 4:
										return l = y("tableHandle", e, t, n, r), u = y("keys", e, t, n), c = y("defaultValue", e, t, n), [4, (d = r.getHashTableById(l.id)).find(u, c)];
									case 6:
										return l = y("tableHandle", e, t, n, r), [2, [(d = r.getHashTableById(l.id)).tensorSize()]];
									case 7:
										throw TypeError("Node type ".concat(e.op, " is not implemented"))
								}
							}))
	...
	var Ji = function() {
		function e(e, t, n, r, a) {
			void 0 === e && (e = {}), void 0 === t && (t = {}), void 0 === n && (n = {}), void 0 === r && (r = {}), this.weightMap = e, this.tensorArrayMap = t, this.tensorListMap = n, this.functionMap = r, this.parseNodeNameCache = a, this.rootContext = {
				id: 0,
				frameName: "",
				iterationId: 0
	...
	function $i(e, t, n, r) {
		...
		for (var p = new Set(r.map((function(e) {
			...
			(ou(f) || su(f) || iu(f)) && null == s && (i = (s = f).children.map((function(e) {
				...
				return a.has(e)
			}))), a.add(f.name), null == n[f.name] && (c.has(f.name) || p.has(f.name) || (0 !== f.inputs.length ? f.inputs.forEach((function(e) {
			...
			for (var w = l(g), k = w.next(); !k.done; k = w.next()) {
				...
				try {
					for (var T = (a = void 0, l(O.children)), S = T.next(); !S.done; S = T.next()) {
						m(M = S.value) || (x[M.name] = Number.POSITIVE_INFINITY), x[M.name] = (x[M.name] || 0) + 1
					}
				} catch (e) {
					a = {
						error: e
		...
		return function(e, t) {
			...
			try {
				for (var f = l(e), m = f.next(); !m.done; m = f.next()) {
					var y = m.value;
					try {
						for (var v = (a = void 0, l(y.children.filter(h))), g = v.next(); !g.done; g = v.next()) {
							var b = g.value;
							if (!u.has(b.name)) throw new tu("Child ".concat(b.name, " of node ").concat(y.name, " is unreachable."));
							if (u.get(y.name) > u.get(b.name)) throw new tu("Node ".concat(y.name, " is scheduled to run after its child ").concat(b.name, "."))
						}
					} catch (e) {
						a = {
							error: e
					...
					if (!p(y)) try {
						for (var x = (s = void 0, l(y.inputs)), N = x.next(); !N.done; N = x.next()) {
							var w = N.value;
							if (!u.has(w.name)) throw new tu("Input ".concat(w.name, " of node ").concat(y.name, " is unreachable."));
							if (u.get(w.name) > u.get(y.name)) throw new tu("Node ".concat(y.name, " is scheduled to run before its input ").concat(w.name, "."))
						}
					} catch (e) {
						s = {
							error: e
	...
	var nu = new Set(["Switch", "Merge", "Enter", "Exit", "NextIteration", "StatelessIf", "StatelessWhile", "if", "While"]),
		ru = new Set(["NonMaxSuppressionV2", "NonMaxSuppressionV3", "NonMaxSuppressionV5", "Where"]),
		au = new Set(["HashTable", "HashTableV2", "LookupTableImport", "LookupTableImportV2", "LookupTableFind", "LookupTableFindV2", "LookupTableSize", "LookupTableSizeV2"]);
	...
	var uu = function() {
			...
			return Object.defineProperty(e.prototype, "weightIds", {
				...
				var n = $i(e, t, this.weightMap, this._initNodes),
					...
					a = n.dynamicNode,
					o = n.syncInputs;
				if (null != a) throw new Error("This execution contains the node '".concat(a.name, "', which has ") + "the dynamic op '".concat(a.op, "'. Please use ") + "model.executeAsync() instead. Alternatively, to avoid the " + "dynamic ops, specify the inputs [".concat(o, "]"));
				if (r.length > 0) {
					var s = t.map((function(e) {
							return e.name
						})),
						i = Object.keys(e);
					throw new Error("Cannot compute the outputs [".concat(s, "] from the provided inputs ") + "[".concat(i, "]. Missing the following inputs: [").concat(r, "]"))
				}
				...
				var h = {},
					f = {};
				return t.tidy((function() {
					var a, o, s = new Ji(r.weightMap, h, f, r.functionExecutorMap, r.parseNodeNameCache),
						u = Object.assign({}, r.weightMap);
					r.keepIntermediateTensors && (r.clonedTensorsMap = r.cloneTensorMap(r.weightMap)), Object.keys(e).forEach((function(t) {
						var n = d(N(t, s), 2),
							a = n[0],
							o = [];
						o[n[1]] = e[t], u[a] = o, r.keepIntermediateTensors && (r.clonedTensorsMap[a] = r.cloneTensorList(o))
					}));
					...
					try {
						for (var g = l(m), b = g.next(); !b.done; b = g.next()) {
							...
							if (!u[x.name]) {
								...
								if (t.util.isPromise(w)) throw new Error("The execution of the op '".concat(x.op, "' returned a promise. ") + "Please use model.executeAsync() instead.");
								u[x.name] = w, r.keepIntermediateTensors && (r.clonedTensorsMap[x.name] = r.cloneTensorList(w)), r.checkTensorForDisposalWithNodeLiveUntilInfo(x, u, s, c, i, y.get(x.name))
							}
						}
					} catch (e) {
						a = {
					...
					try {
						for (var y = l(t.inputs), v = y.next(); !v.done; v = y.next()) {
							...
							if (!ou(b)) {
								var x = g(b.name, n, r);
								if (null != x) try {
									for (var N = (d = void 0, l(x)), w = N.next(); !w.done; w = N.next()) {
										var k;
										if ((k = w.value) && !k.kept && !a.has(k.id)) {
											var T = s[k.id];
											1 === T ? (k.dispose(), delete s[k.id]) : null != T && s[k.id]--
										}
									}
								} catch (e) {
									d = {
				...
				return void 0 === r && (r = !1), void 0 === a && (a = {}), void 0 === o && (o = {}), c(this, void 0, void 0, (function() {
					var s, i, u, c, l, f;
					return p(this, (function(p) {
						switch (p.label) {
							case 0:
								...
								return s = new Ji(this.weightMap, a, o, this.functionExecutorMap, this.parseNodeNameCache), this.keepIntermediateTensors && (this.clonedTensorsMap = this.cloneTensorMap(this.weightMap)), [4, this.executeWithControlFlow(e, s, n, r)];
							case 1:
								return i = p.sent(), u = n.map((function(e) {
									...
									return e[t].id
								})), f = new Set(h(h(h([], d(c), !1), d(l), !1), d(this.weightIds), !1)), Object.values(i).forEach((function(e) {
									e.forEach((function(e) {
						...
						switch (p.label) {
							case 0:
								a = Object.keys(e), o = a.map((function(e) {
									...
									return N(e)[0]
								})), i = new Set(s), 0 === (u = s.map((function(e) {
									return E.graph.nodes[e]
								}))).length && (u = this._outputs), c = $i(e, u, this.weightMap, this._initNodes), l = c.usedNodes, f = c.missingInputs, m = c.dynamicNode, y = c.syncInputs, g = h(h(h([], d(o), !1), d(this.graph.weights), !1), d(this._initNodes || []), !1).map((function(e) {
									return {
										node: e,
										contexts: t.currentContext
									}
								})), b = Object.assign({}, this.weightMap), Object.keys(e).forEach((function(t) {
									var n = d(N(t), 2),
										r = n[0],
										a = [];
									a[n[1]] = e[t], b[r] = a
								})), x = {}, w = this.getFrozenTensorIds(b), k = {}, p.label = 1;
							case 1:
								return g.length > 0 ? (T = this.processStack(o, g, t, b, k, w, i, x, l), [4, Promise.all(T)]) : [3, 3];
							case 2:
								return p.sent(), [3, 1];
							case 3:
								if (null != m || r || console.warn("This model execution did not contain any nodes with control flow or dynamic output shapes. You can use model.execute() instead."), (S = u.filter((function(e) {
										return !ou(e) && !v(e.name, b, t)
									})).map((function(e) {
										return e.name
									}))).length > 0) throw _ = "", null != m && (_ = "Alternatively, to avoid the dynamic ops, use model.execute() " + "and specify the inputs [".concat(y, "]")), new Error("Cannot compute the outputs [".concat(S, "] from the provided ") + "inputs [".concat(a, "]. Consider providing the following inputs: ") + "[".concat(f, "]. ").concat(_));
								return [2, b]
						}
					}))
				}))
				...
				for (var p = this, l = [], h = function() {
						...
						var v = "";
						if ("Enter" === m.node.op && y("isConstant", m.node, a, r) && (e = d(b(m.node.name, r), 1), v = e[0]), null == a[m.node.name]) {
							...
							t.util.isPromise(g) ? l.push(g.then((function(e) {
								return a[v] = e, p.keepIntermediateTensors && (p.clonedTensorsMap[v] = p.cloneTensorList(e)), r.currentContext = x, p.checkTensorForDisposal(v, m.node, a, r, s, i, u), p.processChildNodes(m.node, n, r, a, o, c), e
							}))) : (a[v] = g, f.keepIntermediateTensors && (f.clonedTensorsMap[v] = f.cloneTensorList(g)), f.checkTensorForDisposal(v, m.node, a, r, s, i, u), f.processChildNodes(m.node, n, r, a, o, c))
				...
				e.children.forEach((function(e) {
					...
					!a[s] && o.has(e.name) && ("Merge" === e.op ? e.inputNames.some((function(e) {
						return !!v(e, r, n)
					})) && (a[s] = !0, t.push({
				...
				Object.keys(e).forEach((function(r) {
					...
					if (s.attrParams.shape && s.attrParams.shape.value) {
						...
						t.util.assert(u, (function() {
							return "The shape of dict['".concat(s.name, "'] provided in ") + "model.execute(dict) must be [".concat(i, "], but was ") + "[".concat(a.shape, "]")
						}))
					}
					s.attrParams.dtype && s.attrParams.dtype.value && t.util.assert(a.dtype === s.attrParams.dtype.value, (function() {
						return "The dtype of dict['".concat(s.name, "'] provided in ") + "model.execute(dict) must be " + "".concat(s.attrParams.dtype.value, ", but was ").concat(a.dtype)
					}))
				}))
			}, e.prototype.mapInputs = function(e) {
				var t, n, r = {};
				for (var a in e) {
					var o = null === (n = null === (t = this._signature) || void 0 === t ? void 0 : t.inputs) || void 0 === n ? void 0 : n[a];
	...
	function lu(e, t) {
		return c(this, void 0, void 0, (function() {
			...
			return p(this, (function(p) {
				switch (p.label) {
					case 0:
						return n = pe(e.shape), "quantization" in e ? (a = e.quantization, r = pu[a.dtype], [3, 7]) : [3, 1];
					case 1:
						if ("string" !== e.dtype) return [3, 6];
						o = 0, s = 0, p.label = 2;
					case 2:
						return s < n ? (i = o, u = 4, c = Uint32Array.bind, [4, t(o, o + 4)]) : [3, 5];
					case 3:
						o = i + (u + (new(c.apply(Uint32Array, [void 0, p.sent()])))[0]), p.label = 4;
					case 4:
						return s++, [3, 2];
					case 5:
						return [2, o];
	...
	function du(e, t) {
		...
		if ("quantization" in e) {
			...
			if ("uint8" === l.dtype || "uint16" === l.dtype) {
				if (!("min" in l) || !("scale" in l)) throw new Error("Weight ".concat(e.name, " with quantization ").concat(l.dtype, " ") + "doesn't have corresponding metadata min and scale.")
			} else {
				if ("float16" !== l.dtype) throw new Error("Weight ".concat(e.name, " has unknown ") + "quantization dtype ".concat(l.dtype, ". ") + "Supported quantization dtypes are: 'uint8', 'uint16', and 'float16'.");
				if ("float32" !== i) throw new Error("Weight ".concat(e.name, " is quantized with ").concat(l.dtype, " ") + "which only supports weights of type float32 not ".concat(i, "."))
			}
			var d = pu[l.dtype],
			...
			if ("float32" === i)
				if ("uint8" === l.dtype || "uint16" === l.dtype) {
					...
					if ("float16" !== l.dtype) throw new Error("Unsupported quantization type ".concat(l.dtype, " ") + "for weight type float32.");
					var y = (r = function() {
						var e = function(e) {
						...
						for (var t = new ArrayBuffer(4 * e.length), n = new Uint32Array(t), s = 0; s < e.length; s++) {
							var i = e[s],
				...
				if ("uint8" !== l.dtype && "uint16" !== l.dtype) throw new Error("Unsupported quantization type ".concat(l.dtype, " ") + "for weight type int32.");
		...
		return c(this, void 0, void 0, (function() {
			...
			return p(this, (function(c) {
				switch (c.label) {
					...
					case 2:
						if (a = c.sent(), o = a.done, s = a.value, o && null == s) throw i = n - r.byteLength, new Error("Reader is done but ".concat(i, " bytes are still expected"));
						return (u = new Uint8Array(r.length + s.byteLength)).set(r, 0), u.set(new Uint8Array(s), r.length), r = u, [3, 1];
					case 3:
						return [2, r.buffer]
				}
			}))
		...
		return c(this, void 0, void 0, (function() {
			...
			return p(this, (function(b) {
				switch (b.label) {
					...
					case 4:
						a = b.sent(), d = a.slice(0, u), a = a.slice(u), h = du(i, d), n[i.name] = h, "webgpu" === on.backendName && "uploadToGPU" in (f = on.backend) && pe(h.shape) >= De().get("WEBGPU_CPU_HANDOFF_SIZE_THRESHOLD") && f.uploadToGPU(h.dataId), b.label = 5;
					case 5:
						return s = o.next(), [3, 2];
					case 6:
						return [3, 9];
	...
	var mu = "?tfjs-format=file",
		...
		vu = function() {
			function e(e, n, r) {
				void 0 === n && (n = {}), void 0 === r && (r = t.io), this.modelUrl = e, this.loadOptions = n, this.version = "n/a", this.io = r, null == n && (this.loadOptions = {}), this.resourceManager = new cu
			}
			return Object.defineProperty(e.prototype, "modelVersion", {
				...
				return c(this, void 0, void 0, (function() {
					...
					return p(this, (function(n) {
						switch (n.label) {
							case 0:
								if (null == e.getWeightStream) throw new Error("Model artifacts missing streamWeights function");
								return [4, fu(e.getWeightStream(), e.weightSpecs)];
							case 1:
								return t = n.sent(), [2, this.loadWithWeightMap(e, t)]
						}
					}))
				}))
				...
				if (this.signature = r, this.version = "".concat(n.versions.producer, ".").concat(n.versions.minConsumer), this.executor = new uu(q.Instance.transformGraph(n, this.signature)), this.executor.weightMap = this.convertTensorMapToTensorsMap(t), this.executor.resourceManager = this.resourceManager, null != e.modelInitializer && null != e.modelInitializer.node) {
					...
					this.initializer = new uu(o), this.initializer.weightMap = this.executor.weightMap, this.initializer.resourceManager = this.resourceManager, this.initializerSignature = e.initializerSignature
				}
				return !0
				...
				return c(this, void 0, void 0, (function() {
					...
					return p(this, (function(n) {
						if ("string" == typeof e) {
							if (0 === (t = this.io.getSaveHandlers(e)).length) throw new Error("Cannot find any save handlers for URL '".concat(e, "'"));
							if (t.length > 1) throw new Error("Found more than one (".concat(t.length, ") save handlers for ") + "URL '".concat(e, "'"));
							e = t[0]
						}
				...
				return c(this, void 0, void 0, (function() {
					...
					return p(this, (function(n) {
						switch (n.label) {
							...
							case 1:
								return t = n.sent(), [2, this.addStructuredOutputNames(t)]
						}
					}))
				}))
				...
				if (e.length + i !== this.inputNodes.length) throw new Error("Input tensor count mismatch, the graph model has ".concat(this.inputNodes.length - i, " non-resource placeholders, while there are ").concat(e.length, " input tensors provided."));
				var u = 0;
				return this.inputNodes.reduce((function(t, n) {
					var a, o, s, i = null === (s = null === (o = null === (a = r.signature) || void 0 === a ? void 0 : a.inputs) || void 0 === o ? void 0 : o[n]) || void 0 === s ? void 0 : s.resourceId;
				...
				return c(this, void 0, void 0, (function() {
					return p(this, (function(e) {
						return null == this.initializer ? [2, []] : null == this.initializerSignature ? [2, this.initializer.executeAsync({}, [])] : [2, this.initializer.executeAsync({}, Object.keys(this.initializerSignature.outputs))]
					}))
				}))
				...
				return c(this, void 0, void 0, (function() {
					...
					return p(this, (function(a) {
						switch (a.label) {
							case 0:
								return null != this.resourceIdToCapturedInput ? [3, 2] : (n = this.setResourceIdToCapturedInput, [4, this.executeInitializerGraphAsync()]);
							case 1:
				...
				this.executor.dispose(), this.initializer && (this.initializer.dispose(), this.resourceIdToCapturedInput && t.dispose(this.resourceIdToCapturedInput)), this.resourceManager.dispose()
			}, e
		}();
	e.GraphModel = vu, e.deregisterOp = function(e) {
			...
			return p(this, (function(a) {
				switch (a.label) {
					case 0:
						...
						return null == n && (n = {}), n.fromTFHub && "string" == typeof e && (e = function(e) {
							e.endsWith("/") || (e += "/");
		...
		if (e instanceof Array) {
			...
			if (!(o && o instanceof ArrayBuffer)) throw new Error("An ArrayBuffer of weights must be the second element of the array");
